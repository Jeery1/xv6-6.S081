...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c8:	44c50513          	addi	a0,a0,1100 # 810 <digits>
 3cc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 494:	380b8b93          	addi	s7,s7,896 # 810 <digits>
 ...
 5d4:	23890913          	addi	s2,s2,568 # 808 <malloc+0xf2>
        while(*s != 0){
...
free(void *ap)
{
 ...
 69c:	1907b783          	ld	a5,400(a5) # 828 <freep>
 ...
 6ca:	00e6ea63          	bltu	a3,a4,6de <free+0x50>
{
 ...
 70c:	12f73023          	sd	a5,288(a4) # 828 <freep>
}
 710:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73e:	0ee53503          	ld	a0,238(a0) # 828 <freep>
 ...
 766:	0c690913          	addi	s2,s2,198 # 828 <freep>
  if(p == (char*)-1)
 76a:	5afd                	li	s5,-1
 76c:	a88d                	j	7de <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 76e:	00000797          	auipc	a5,0x0
 772:	0c278793          	addi	a5,a5,194 # 830 <base>
 776:	00000717          	auipc	a4,0x0
 77a:	0af73923          	sd	a5,178(a4) # 828 <freep>
 77e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a0:	08a73623          	sd	a0,140(a4) # 828 <freep>
      return (void*)(p + 1);
 ...
 7ee:	b4e080e7          	jalr	-1202(ra) # 338 <sbrk>
  if(p == (char*)-1)
