 ...
 63a:	00e6ea63          	bltu	a3,a4,64e <free+0x50>
{
 ...
 652:	6390                	ld	a2,0(a5)
 654:	02059713          	slli	a4,a1,0x20
 658:	9301                	srli	a4,a4,0x20
 65a:	0712                	slli	a4,a4,0x4
...
malloc(uint nbytes)
{
 ...
 6f4:	b7e1                	j	6bc <malloc+0x36>
      if(p->s.size == nunits)
 6f6:	02e48b63          	beq	s1,a4,72c <malloc+0xa6>
        p->s.size -= nunits;
 ...
 72c:	6398                	ld	a4,0(a5)
 72e:	e118                	sd	a4,0(a0)
 730:	bff1                	j	70c <malloc+0x86>
  hp->s.size = nu;
 732:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 736:	0541                	addi	a0,a0,16
 738:	00000097          	auipc	ra,0x0
 73c:	ec6080e7          	jalr	-314(ra) # 5fe <free>
  return freep;
 740:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 744:	d971                	beqz	a0,718 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 746:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 748:	4798                	lw	a4,8(a5)
 74a:	fa9776e3          	bgeu	a4,s1,6f6 <malloc+0x70>
    if(p == freep)
 74e:	00093703          	ld	a4,0(s2)
 752:	853e                	mv	a0,a5
 754:	fef719e3          	bne	a4,a5,746 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 758:	8552                	mv	a0,s4
 75a:	00000097          	auipc	ra,0x0
 75e:	b5e080e7          	jalr	-1186(ra) # 2b8 <sbrk>
  if(p == (char*)-1)
 762:	fd5518e3          	bne	a0,s5,732 <malloc+0xac>
        return 0;
 766:	4501                	li	a0,0
 768:	bf45                	j	718 <malloc+0x92>
