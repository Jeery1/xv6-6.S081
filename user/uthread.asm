...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 5c4:	fed70fa3          	sb	a3,-1(a4) # 1fff <__global_pointer$+0xb5e>
    while(n-- > 0)
...
putc(int fd, char c)
{
 ...
 724:	f56080e7          	jalr	-170(ra) # 676 <write>
}
...
malloc(uint nbytes)
{
 ...
 b7c:	b66080e7          	jalr	-1178(ra) # 6de <sbrk>
  if(p == (char*)-1)
