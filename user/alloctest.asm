...
test0() {
  ...
  16:	96e50513          	addi	a0,a0,-1682 # 980 <malloc+0xe4>
  ...
  44:	970a8a93          	addi	s5,s5,-1680 # 9b0 <malloc+0x114>
      all_ok = 0;
  48:	4a01                	li	s4,0
  4a:	a8b1                	j	a6 <test0+0xa6>
      printf("fork failed");
  4c:	00001517          	auipc	a0,0x1
  50:	94c50513          	addi	a0,a0,-1716 # 998 <malloc+0xfc>
  ...
  6c:	94090913          	addi	s2,s2,-1728 # 9a8 <malloc+0x10c>
  70:	4581                	li	a1,0
  72:	854a                	mv	a0,s2
  ...
  e4:	8e850513          	addi	a0,a0,-1816 # 9c8 <malloc+0x12c>
...
void test1()
{
 ...
 104:	8d850513          	addi	a0,a0,-1832 # 9d8 <malloc+0x13c>
 ...
 142:	8ba98993          	addi	s3,s3,-1862 # 9f8 <malloc+0x15c>
        a = sbrk(PGSIZE);
 146:	6505                	lui	a0,0x1
 ...
 16e:	89650513          	addi	a0,a0,-1898 # a00 <malloc+0x164>
 ...
 188:	86450513          	addi	a0,a0,-1948 # 9e8 <malloc+0x14c>
 ...
 1a2:	7fa50513          	addi	a0,a0,2042 # 998 <malloc+0xfc>
 ...
 1e8:	b7dd                	j	1ce <test1+0xdc>
  ...
  if(tot < 31950) {
 1ea:	67a1                	lui	a5,0x8
 1ec:	ccd78793          	addi	a5,a5,-819 # 7ccd <__global_pointer$+0x6a44>
 1f0:	0297ca63          	blt	a5,s1,224 <test1+0x132>
    printf("expected to allocate at least 31950, only got %d\n", tot);
 1f4:	85a6                	mv	a1,s1
 1f6:	00001517          	auipc	a0,0x1
 1fa:	81a50513          	addi	a0,a0,-2022 # a10 <malloc+0x174>
 1fe:	00000097          	auipc	ra,0x0
 202:	5e0080e7          	jalr	1504(ra) # 7de <printf>
    printf("memtest: FAILED\n");  
 206:	00001517          	auipc	a0,0x1
 20a:	84250513          	addi	a0,a0,-1982 # a48 <malloc+0x1ac>
 ...
 228:	83c50513          	addi	a0,a0,-1988 # a60 <malloc+0x1c4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 54e:	52e50513          	addi	a0,a0,1326 # a78 <digits>
 552:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 61a:	462b8b93          	addi	s7,s7,1122 # a78 <digits>
 ...
 75a:	31a90913          	addi	s2,s2,794 # a70 <malloc+0x1d4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 822:	2727b783          	ld	a5,626(a5) # a90 <freep>
 ...
 850:	00e6ea63          	bltu	a3,a4,864 <free+0x50>
{
 ...
 892:	20f73123          	sd	a5,514(a4) # a90 <freep>
}
 896:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8c4:	1d053503          	ld	a0,464(a0) # a90 <freep>
 ...
 8ec:	1a890913          	addi	s2,s2,424 # a90 <freep>
  if(p == (char*)-1)
 8f0:	5afd                	li	s5,-1
 8f2:	a88d                	j	964 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 8f4:	00000797          	auipc	a5,0x0
 8f8:	1a478793          	addi	a5,a5,420 # a98 <base>
 8fc:	00000717          	auipc	a4,0x0
 900:	18f73a23          	sd	a5,404(a4) # a90 <freep>
 904:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 926:	16a73723          	sd	a0,366(a4) # a90 <freep>
      return (void*)(p + 1);
