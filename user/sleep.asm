...
parse_cmd(int argc, char** argv){
   ...
   4:	0800                	addi	s0,sp,16
    if(argc > 2){
   6:	4789                	li	a5,2
   8:	02a7c463          	blt	a5,a0,30 <parse_cmd+0x30>
        return toomany_char;
    }
    else {
        int i = 0;
   ...
   c:	6598                	ld	a4,8(a1)
   e:	00074783          	lbu	a5,0(a4)
  12:	c38d                	beqz	a5,34 <parse_cmd+0x34>
  ...
  20:	00f6ec63          	bltu	a3,a5,38 <parse_cmd+0x38>
        while (argv[duration_pos][i] != '\0')
  24:	0705                	addi	a4,a4,1
  26:	fff74783          	lbu	a5,-1(a4)
  2a:	f7fd                	bnez	a5,18 <parse_cmd+0x18>
            }
            i++;
        }
  ...
  2c:	4505                	li	a0,1
  2e:	a031                	j	3a <parse_cmd+0x3a>
        return toomany_char;
  30:	4509                	li	a0,2
  32:	a021                	j	3a <parse_cmd+0x3a>
    return success_parse;
  34:	4505                	li	a0,1
  36:	a011                	j	3a <parse_cmd+0x3a>
                return wrong_char;
  38:	4501                	li	a0,0
}
  3a:	6422                	ld	s0,8(sp)
...
main(int argc, char** argv){
  ...
  48:	1000                	addi	s0,sp,32
    if(argc == 1){
  4a:	4785                	li	a5,1
  4c:	02f50963          	beq	a0,a5,7e <main+0x3e>
  50:	84ae                	mv	s1,a1
        parse_result = parse_cmd(argc, argv);
  52:	00000097          	auipc	ra,0x0
  56:	fae080e7          	jalr	-82(ra) # 0 <parse_cmd>
  5a:	2501                	sext.w	a0,a0
        if(parse_result == toomany_char){
  5c:	4789                	li	a5,2
  5e:	02f50d63          	beq	a0,a5,98 <main+0x58>
        else if(parse_result == wrong_char){
  62:	e921                	bnez	a0,b2 <main+0x72>
            printf("Cannot input alphabet, number only \n");
  64:	00001517          	auipc	a0,0x1
  68:	83450513          	addi	a0,a0,-1996 # 898 <malloc+0x11e>
  6c:	00000097          	auipc	ra,0x0
  70:	650080e7          	jalr	1616(ra) # 6bc <printf>
            exit(1);
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	2c6080e7          	jalr	710(ra) # 33c <exit>
        printf("Please enter the parameters!");
  7e:	00000517          	auipc	a0,0x0
  82:	7e250513          	addi	a0,a0,2018 # 860 <malloc+0xe6>
  86:	00000097          	auipc	ra,0x0
  8a:	636080e7          	jalr	1590(ra) # 6bc <printf>
        exit(1);
  8e:	4505                	li	a0,1
  90:	00000097          	auipc	ra,0x0
  94:	2ac080e7          	jalr	684(ra) # 33c <exit>
            printf("Too many args! \n");
  98:	00000517          	auipc	a0,0x0
  9c:	7e850513          	addi	a0,a0,2024 # 880 <malloc+0x106>
  a0:	00000097          	auipc	ra,0x0
  a4:	61c080e7          	jalr	1564(ra) # 6bc <printf>
            exit(1);
  a8:	4505                	li	a0,1
  aa:	00000097          	auipc	ra,0x0
  ae:	292080e7          	jalr	658(ra) # 33c <exit>
            int duration = atoi(argv[duration_pos]);
  b2:	6488                	ld	a0,8(s1)
  b4:	00000097          	auipc	ra,0x0
  b8:	18c080e7          	jalr	396(ra) # 240 <atoi>
            sleep(duration);
  bc:	00000097          	auipc	ra,0x0
  c0:	310080e7          	jalr	784(ra) # 3cc <sleep>
            exit(0);
  c4:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42c:	4a050513          	addi	a0,a0,1184 # 8c8 <digits>
 430:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	3d4b8b93          	addi	s7,s7,980 # 8c8 <digits>
 ...
 638:	28c90913          	addi	s2,s2,652 # 8c0 <malloc+0x146>
        while(*s != 0){
...
free(void *ap)
{
 ...
 700:	1e47b783          	ld	a5,484(a5) # 8e0 <freep>
 ...
 72e:	00e6ea63          	bltu	a3,a4,742 <free+0x50>
{
 ...
 770:	16f73a23          	sd	a5,372(a4) # 8e0 <freep>
}
 774:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a2:	14253503          	ld	a0,322(a0) # 8e0 <freep>
 ...
 7ca:	11a90913          	addi	s2,s2,282 # 8e0 <freep>
  if(p == (char*)-1)
 7ce:	5afd                	li	s5,-1
 7d0:	a88d                	j	842 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7d2:	00000797          	auipc	a5,0x0
 7d6:	11678793          	addi	a5,a5,278 # 8e8 <base>
 7da:	00000717          	auipc	a4,0x0
 7de:	10f73323          	sd	a5,262(a4) # 8e0 <freep>
 7e2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 804:	0ea73023          	sd	a0,224(a4) # 8e0 <freep>
      return (void*)(p + 1);
