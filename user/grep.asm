...
00000000000001de <main>:
{
 ...
 252:	80a58593          	addi	a1,a1,-2038 # a58 <malloc+0xe6>
 256:	4509                	li	a0,2
 ...
 288:	7f450513          	addi	a0,a0,2036 # a78 <malloc+0x106>
...
putc(int fd, char c)
{
 ...
 5f2:	f3e080e7          	jalr	-194(ra) # 52c <write>
}
...
malloc(uint nbytes)
{
 ...
 a4a:	b4e080e7          	jalr	-1202(ra) # 594 <sbrk>
  if(p == (char*)-1)
