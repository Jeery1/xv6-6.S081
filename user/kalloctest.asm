...
void test0()
{
  ...
  12:	9fa50513          	addi	a0,a0,-1542 # a08 <malloc+0xea>
  16:	00001097          	auipc	ra,0x1
  1a:	84a080e7          	jalr	-1974(ra) # 860 <printf>
  ntas(0);
  1e:	4501                	li	a0,0
  20:	00000097          	auipc	ra,0x0
  24:	548080e7          	jalr	1352(ra) # 568 <ntas>
  for(int i = 0; i < NCHILD; i++){
    int pid = fork();
  28:	00000097          	auipc	ra,0x0
  2c:	498080e7          	jalr	1176(ra) # 4c0 <fork>
    if(pid < 0){
  ...
  3a:	48a080e7          	jalr	1162(ra) # 4c0 <fork>
    if(pid < 0){
  ...
  4a:	48a080e7          	jalr	1162(ra) # 4d0 <wait>
  4e:	4501                	li	a0,0
  50:	00000097          	auipc	ra,0x0
  54:	480080e7          	jalr	1152(ra) # 4d0 <wait>
  }
  printf("test0 results:\n");
  58:	00001517          	auipc	a0,0x1
  5c:	9e050513          	addi	a0,a0,-1568 # a38 <malloc+0x11a>
  60:	00001097          	auipc	ra,0x1
  64:	800080e7          	jalr	-2048(ra) # 860 <printf>
  n = ntas(1);
  68:	4505                	li	a0,1
  6a:	00000097          	auipc	ra,0x0
  6e:	4fe080e7          	jalr	1278(ra) # 568 <ntas>
  if(n < 10) 
  72:	47a5                	li	a5,9
  74:	08a7c863          	blt	a5,a0,104 <test0+0x104>
    printf("test0 OK\n");
  78:	00001517          	auipc	a0,0x1
  7c:	9d050513          	addi	a0,a0,-1584 # a48 <malloc+0x12a>
  80:	00000097          	auipc	ra,0x0
  84:	7e0080e7          	jalr	2016(ra) # 860 <printf>
  else
    printf("test0 FAIL\n");
}
  88:	70a2                	ld	ra,40(sp)
  ...
  9a:	98250513          	addi	a0,a0,-1662 # a18 <malloc+0xfa>
  9e:	00000097          	auipc	ra,0x0
  a2:	7c2080e7          	jalr	1986(ra) # 860 <printf>
      exit(-1);
  a6:	557d                	li	a0,-1
  a8:	00000097          	auipc	ra,0x0
  ac:	420080e7          	jalr	1056(ra) # 4c8 <exit>
{
  b0:	6961                	lui	s2,0x18
  b2:	6a090913          	addi	s2,s2,1696 # 186a0 <__global_pointer$+0x1736f>
        *(int *)(a+4) = 1;
  b6:	4985                	li	s3,1
        a = sbrk(4096);
  b8:	6505                	lui	a0,0x1
  ba:	00000097          	auipc	ra,0x0
  be:	496080e7          	jalr	1174(ra) # 550 <sbrk>
  c2:	84aa                	mv	s1,a0
        *(int *)(a+4) = 1;
  c4:	01352223          	sw	s3,4(a0) # 1004 <__BSS_END__+0x4b4>
        a1 = sbrk(-4096);
  c8:	757d                	lui	a0,0xfffff
  ca:	00000097          	auipc	ra,0x0
  ce:	486080e7          	jalr	1158(ra) # 550 <sbrk>
        if (a1 != a + 4096) {
  d2:	6785                	lui	a5,0x1
  ...
  e6:	3e6080e7          	jalr	998(ra) # 4c8 <exit>
          printf("wrong sbrk\n");
  ea:	00001517          	auipc	a0,0x1
  ee:	93e50513          	addi	a0,a0,-1730 # a28 <malloc+0x10a>
  f2:	00000097          	auipc	ra,0x0
  f6:	76e080e7          	jalr	1902(ra) # 860 <printf>
          exit(-1);
  fa:	557d                	li	a0,-1
  fc:	00000097          	auipc	ra,0x0
 100:	3cc080e7          	jalr	972(ra) # 4c8 <exit>
    printf("test0 FAIL\n");
 104:	00001517          	auipc	a0,0x1
 108:	95450513          	addi	a0,a0,-1708 # a58 <malloc+0x13a>
 10c:	00000097          	auipc	ra,0x0
 110:	754080e7          	jalr	1876(ra) # 860 <printf>
}
...
void test1()
{
 ...
 128:	94450513          	addi	a0,a0,-1724 # a68 <malloc+0x14a>
 12c:	00000097          	auipc	ra,0x0
 130:	734080e7          	jalr	1844(ra) # 860 <printf>
  for(int i = 0; i < NCHILD; i++){
 ...
 140:	39c080e7          	jalr	924(ra) # 4d8 <pipe>
 144:	84aa                	mv	s1,a0
 ...
 14c:	378080e7          	jalr	888(ra) # 4c0 <fork>
    if(pid < 0){
 ...
 15e:	396080e7          	jalr	918(ra) # 4f0 <close>
      pipes[i] = fds[0];
 ...
 17a:	90250513          	addi	a0,a0,-1790 # a78 <malloc+0x15a>
 17e:	00000097          	auipc	ra,0x0
 182:	6e2080e7          	jalr	1762(ra) # 860 <printf>
      exit(-1);
 186:	557d                	li	a0,-1
 188:	00000097          	auipc	ra,0x0
 18c:	340080e7          	jalr	832(ra) # 4c8 <exit>
      printf("fork failed");
 190:	00001517          	auipc	a0,0x1
 194:	88850513          	addi	a0,a0,-1912 # a18 <malloc+0xfa>
 198:	00000097          	auipc	ra,0x0
 19c:	6c8080e7          	jalr	1736(ra) # 860 <printf>
      exit(-1);
 1a0:	557d                	li	a0,-1
 1a2:	00000097          	auipc	ra,0x0
 1a6:	326080e7          	jalr	806(ra) # 4c8 <exit>
      close(fds[0]);
 1aa:	fb842503          	lw	a0,-72(s0)
 1ae:	00000097          	auipc	ra,0x0
 1b2:	342080e7          	jalr	834(ra) # 4f0 <close>
 1b6:	64e1                	lui	s1,0x18
 1b8:	6a048493          	addi	s1,s1,1696 # 186a0 <__global_pointer$+0x1736f>
        *(int *)(a+4) = 1;
 1bc:	4905                	li	s2,1
        if (write(fds[1], "x", 1) != 1) {
 1be:	00001997          	auipc	s3,0x1
 1c2:	8ca98993          	addi	s3,s3,-1846 # a88 <malloc+0x16a>
        a = sbrk(PGSIZE);
 1c6:	6505                	lui	a0,0x1
 1c8:	00000097          	auipc	ra,0x0
 1cc:	388080e7          	jalr	904(ra) # 550 <sbrk>
        *(int *)(a+4) = 1;
 1d0:	01252223          	sw	s2,4(a0) # 1004 <__BSS_END__+0x4b4>
        if (write(fds[1], "x", 1) != 1) {
 1d4:	864a                	mv	a2,s2
 1d6:	85ce                	mv	a1,s3
 1d8:	fbc42503          	lw	a0,-68(s0)
 1dc:	00000097          	auipc	ra,0x0
 1e0:	30c080e7          	jalr	780(ra) # 4e8 <write>
 ...
 1f2:	2da080e7          	jalr	730(ra) # 4c8 <exit>
          printf("write failed");
 1f6:	00001517          	auipc	a0,0x1
 1fa:	89a50513          	addi	a0,a0,-1894 # a90 <malloc+0x172>
 1fe:	00000097          	auipc	ra,0x0
 202:	662080e7          	jalr	1634(ra) # 860 <printf>
          exit(-1);
 206:	557d                	li	a0,-1
 208:	00000097          	auipc	ra,0x0
 20c:	2c0080e7          	jalr	704(ra) # 4c8 <exit>
  int stop = 0;
  while (!stop) {
    stop = 1;
    for(int i = 0; i < NCHILD; i++){
 ...
 220:	2c4080e7          	jalr	708(ra) # 4e0 <read>
 224:	4785                	li	a5,1
 ...
 238:	2ac080e7          	jalr	684(ra) # 4e0 <read>
 23c:	4785                	li	a5,1
 ...
 250:	294080e7          	jalr	660(ra) # 4e0 <read>
 254:	4785                	li	a5,1
 ...
 262:	84250513          	addi	a0,a0,-1982 # aa0 <malloc+0x182>
 266:	00000097          	auipc	ra,0x0
 26a:	5fa080e7          	jalr	1530(ra) # 860 <printf>
    exit(-1);
 26e:	557d                	li	a0,-1
 270:	00000097          	auipc	ra,0x0
 274:	258080e7          	jalr	600(ra) # 4c8 <exit>
  printf("total allocated number of pages: %d (out of %d)\n", tot, n);
 278:	6621                	lui	a2,0x8
 27a:	85a6                	mv	a1,s1
 27c:	00001517          	auipc	a0,0x1
 280:	86450513          	addi	a0,a0,-1948 # ae0 <malloc+0x1c2>
 284:	00000097          	auipc	ra,0x0
 288:	5dc080e7          	jalr	1500(ra) # 860 <printf>
  if(n - tot > 1000) {
 28c:	67a1                	lui	a5,0x8
 ...
 29e:	83650513          	addi	a0,a0,-1994 # ad0 <malloc+0x1b2>
 2a2:	00000097          	auipc	ra,0x0
 2a6:	5be080e7          	jalr	1470(ra) # 860 <printf>
}
...
00000000000002b8 <main>:
{
 ...
 2d6:	1f6080e7          	jalr	502(ra) # 4c8 <exit>
...
strcpy(char *s, const char *t)
{
 ...
 2ea:	fee78fa3          	sb	a4,-1(a5) # 7fff <__global_pointer$+0x6cce>
...
gets(char *buf, int max)
{
 ...
 3c8:	11c080e7          	jalr	284(ra) # 4e0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 41a:	0f2080e7          	jalr	242(ra) # 508 <open>
  if(fd < 0)
 ...
 42a:	0fa080e7          	jalr	250(ra) # 520 <fstat>
 42e:	892a                	mv	s2,a0
  close(fd);
 430:	8526                	mv	a0,s1
 432:	00000097          	auipc	ra,0x0
 436:	0be080e7          	jalr	190(ra) # 4f0 <close>
  return r;
}
 43a:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 49a:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  while(n-- > 0)
 49c:	00c05f63          	blez	a2,4ba <memmove+0x24>
 4a0:	1602                	slli	a2,a2,0x20
 4a2:	9201                	srli	a2,a2,0x20
 4a4:	00c506b3          	add	a3,a0,a2
  dst = vdst;
 4a8:	87aa                	mv	a5,a0
    *dst++ = *src++;
 ...
 4b2:	fee78fa3          	sb	a4,-1(a5)
  while(n-- > 0)
 4b6:	fed79ae3          	bne	a5,a3,4aa <memmove+0x14>
  return vdst;
}
 4ba:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 ...
 59e:	f4e080e7          	jalr	-178(ra) # 4e8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5d0:	55450513          	addi	a0,a0,1364 # b20 <digits>
 5d4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7dc:	34090913          	addi	s2,s2,832 # b18 <malloc+0x1fa>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a4:	2987b783          	ld	a5,664(a5) # b38 <freep>
 ...
 8d2:	00e6ea63          	bltu	a3,a4,8e6 <free+0x50>
{
 ...
 914:	22f73423          	sd	a5,552(a4) # b38 <freep>
}
 918:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 946:	1f653503          	ld	a0,502(a0) # b38 <freep>
 ...
 96e:	1ce90913          	addi	s2,s2,462 # b38 <freep>
  if(p == (char*)-1)
 972:	5afd                	li	s5,-1
 974:	a88d                	j	9e6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 976:	00000797          	auipc	a5,0x0
 97a:	1ca78793          	addi	a5,a5,458 # b40 <base>
 ...
 9a8:	18a73a23          	sd	a0,404(a4) # b38 <freep>
      return (void*)(p + 1);
 ...
 9f6:	b5e080e7          	jalr	-1186(ra) # 550 <sbrk>
  if(p == (char*)-1)
