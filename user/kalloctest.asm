...
void test0()
{
  ...
  14:	9e050513          	addi	a0,a0,-1568 # 9f0 <malloc+0xe4>
  ...
  6a:	9ba50513          	addi	a0,a0,-1606 # a20 <malloc+0x114>
  ...
  8a:	97a50513          	addi	a0,a0,-1670 # a00 <malloc+0xf4>
...
{
  a0:	6961                	lui	s2,0x18
  a2:	6a090913          	addi	s2,s2,1696 # 186a0 <__global_pointer$+0x1738f>
  ...
  b6:	03350063          	beq	a0,s3,d6 <test0+0xd6>
        *(int *)(a+4) = 1;
  ba:	01452223          	sw	s4,4(a0) # 1004 <__BSS_END__+0x4d4>
        a1 = sbrk(-4096);
  ...
  e4:	93050513          	addi	a0,a0,-1744 # a10 <malloc+0x104>
...
void test1()
{
 ...
 10e:	93e50513          	addi	a0,a0,-1730 # a48 <malloc+0x13c>
 ...
 160:	8fc50513          	addi	a0,a0,-1796 # a58 <malloc+0x14c>
 ...
 17a:	88a50513          	addi	a0,a0,-1910 # a00 <malloc+0xf4>
 ...
 19e:	6a048493          	addi	s1,s1,1696 # 186a0 <__global_pointer$+0x1738f>
        if(a == (char*)0xffffffffffffffffL){
 1a2:	5a7d                	li	s4,-1
        *(int *)(a+4) = 1;
 1a4:	4905                	li	s2,1
 ...
 1aa:	8c298993          	addi	s3,s3,-1854 # a68 <malloc+0x15c>
        a = sbrk(PGSIZE);
 1ae:	6505                	lui	a0,0x1
 ...
 1b8:	03450063          	beq	a0,s4,1d8 <test1+0xde>
        *(int *)(a+4) = 1;
 1bc:	01252223          	sw	s2,4(a0) # 1004 <__BSS_END__+0x4d4>
        if (write(fds[1], "x", 1) != 1) {
 1c0:	864a                	mv	a2,s2
 1c2:	85ce                	mv	a1,s3
 ...
 1e6:	88e50513          	addi	a0,a0,-1906 # a70 <malloc+0x164>
 ...
 24e:	83650513          	addi	a0,a0,-1994 # a80 <malloc+0x174>
 ...
 26c:	85850513          	addi	a0,a0,-1960 # ac0 <malloc+0x1b4>
 ...
 28a:	82a50513          	addi	a0,a0,-2006 # ab0 <malloc+0x1a4>
...
strcpy(char *s, const char *t)
{
 ...
 2d8:	fee78fa3          	sb	a4,-1(a5) # 7fff <__global_pointer$+0x6cee>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5be:	54650513          	addi	a0,a0,1350 # b00 <digits>
 5c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68a:	47ab8b93          	addi	s7,s7,1146 # b00 <digits>
 ...
 7ca:	33290913          	addi	s2,s2,818 # af8 <malloc+0x1ec>
        while(*s != 0){
...
free(void *ap)
{
 ...
 892:	28a7b783          	ld	a5,650(a5) # b18 <freep>
 ...
 8c0:	00e6ea63          	bltu	a3,a4,8d4 <free+0x50>
{
 ...
 902:	20f73d23          	sd	a5,538(a4) # b18 <freep>
}
 906:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 934:	1e853503          	ld	a0,488(a0) # b18 <freep>
 ...
 95c:	1c090913          	addi	s2,s2,448 # b18 <freep>
  if(p == (char*)-1)
 960:	5afd                	li	s5,-1
 962:	a88d                	j	9d4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 964:	00000797          	auipc	a5,0x0
 968:	1bc78793          	addi	a5,a5,444 # b20 <base>
 96c:	00000717          	auipc	a4,0x0
 970:	1af73623          	sd	a5,428(a4) # b18 <freep>
 974:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 996:	18a73323          	sd	a0,390(a4) # b18 <freep>
      return (void*)(p + 1);
 ...
 9e4:	b5e080e7          	jalr	-1186(ra) # 53e <sbrk>
  if(p == (char*)-1)
