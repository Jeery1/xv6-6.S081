...
fmtname(char *path)
{
  ...
  6a:	ac298993          	addi	s3,s3,-1342 # b28 <buf.0>
...
putc(int fd, char c)
{
 ...
 628:	f3e080e7          	jalr	-194(ra) # 562 <write>
}
...
malloc(uint nbytes)
{
 ...
 a80:	b4e080e7          	jalr	-1202(ra) # 5ca <sbrk>
  if(p == (char*)-1)
