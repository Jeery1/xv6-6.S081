...
cat(int fd)
{
  ...
  44:	86850513          	addi	a0,a0,-1944 # 8a8 <malloc+0xe4>
...
main(int argc, char *argv[])
{
 ...
 102:	7da50513          	addi	a0,a0,2010 # 8d8 <malloc+0x114>
...
malloc(uint nbytes)
{
 ...
 820:	2fc78793          	addi	a5,a5,764 # b18 <base>
 ...
 89c:	b76080e7          	jalr	-1162(ra) # 40e <sbrk>
  if(p == (char*)-1)
