      ...
      1c:	8082                	ret
{
      ...
      2c:	b4050513          	addi	a0,a0,-1216 # 4b68 <malloc+0x370>
...
0000000000000042 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    printf("%s: mkdir failed\n", s);
      ...
      ae:	ade50513          	addi	a0,a0,-1314 # 4b88 <malloc+0x390>
    ...
    printf("%s: chdir iputdir failed\n", s);
      ...
      ca:	ada50513          	addi	a0,a0,-1318 # 4ba0 <malloc+0x3a8>
    ...
    printf("%s: unlink ../iputdir failed\n", s);
      ...
      e6:	aee50513          	addi	a0,a0,-1298 # 4bd0 <malloc+0x3d8>
    ...
    printf("%s: chdir / failed\n", s);
     ...
     102:	afa50513          	addi	a0,a0,-1286 # 4bf8 <malloc+0x400>
...
0000000000000118 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    printf("%s: mkdir dots failed\n", s);
     ...
     1c4:	a5850513          	addi	a0,a0,-1448 # 4c18 <malloc+0x420>
    ...
    printf("%s: chdir dots failed\n", s);
     ...
     1e0:	a5450513          	addi	a0,a0,-1452 # 4c30 <malloc+0x438>
    ...
    printf("%s: rm . worked!\n", s);
     ...
     1fc:	a5850513          	addi	a0,a0,-1448 # 4c50 <malloc+0x458>
    ...
    printf("%s: rm .. worked!\n", s);
     ...
     218:	a5c50513          	addi	a0,a0,-1444 # 4c70 <malloc+0x478>
    ...
    printf("%s: chdir / failed\n", s);
     ...
     234:	9c850513          	addi	a0,a0,-1592 # 4bf8 <malloc+0x400>
    ...
    printf("%s: unlink dots/. worked!\n", s);
     ...
     250:	a4450513          	addi	a0,a0,-1468 # 4c90 <malloc+0x498>
    ...
    printf("%s: unlink dots/.. worked!\n", s);
     ...
     26c:	a5050513          	addi	a0,a0,-1456 # 4cb8 <malloc+0x4c0>
    ...
    printf("%s: unlink dots failed!\n", s);
     ...
     288:	a5450513          	addi	a0,a0,-1452 # 4cd8 <malloc+0x4e0>
...
000000000000029e <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     2bc:	8c850513          	addi	a0,a0,-1848 # 4b80 <malloc+0x388>
    ...
    if(chdir("iputdir") < 0){
     ...
     2d0:	8b450513          	addi	a0,a0,-1868 # 4b80 <malloc+0x388>
    ...
    if(unlink("../iputdir") < 0){
     ...
     2e4:	8e050513          	addi	a0,a0,-1824 # 4bc0 <malloc+0x3c8>
    ...
    printf("%s: fork failed\n", s);
     ...
     304:	9f850513          	addi	a0,a0,-1544 # 4cf8 <malloc+0x500>
    ...
    exit(1);
     ...
     320:	86c50513          	addi	a0,a0,-1940 # 4b88 <malloc+0x390>
     ...
     33c:	9d850513          	addi	a0,a0,-1576 # 4d10 <malloc+0x518>
     ...
     358:	87c50513          	addi	a0,a0,-1924 # 4bd0 <malloc+0x3d8>
...
0000000000000386 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
     ...
     3e2:	91a50513          	addi	a0,a0,-1766 # 4cf8 <malloc+0x500>
     ...
     3fe:	92e50513          	addi	a0,a0,-1746 # 4d28 <malloc+0x530>
     ...
     41a:	92a50513          	addi	a0,a0,-1750 # 4d40 <malloc+0x548>
...
000000000000043a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
     ...
     492:	86a50513          	addi	a0,a0,-1942 # 4cf8 <malloc+0x500>
     ...
     4b6:	84650513          	addi	a0,a0,-1978 # 4cf8 <malloc+0x500>
...
00000000000004d4 <forkfork>:
{
    ...
    if(xstatus != 0) {
     ...
     530:	83450513          	addi	a0,a0,-1996 # 4d60 <malloc+0x568>
     ...
     542:	e64080e7          	jalr	-412(ra) # 43a2 <exit>
{
     ...
     588:	7ec50513          	addi	a0,a0,2028 # 4d70 <malloc+0x578>
...
000000000000059e <reparent2>:
{
  ...
  exit(0);
     ...
     5d6:	02650513          	addi	a0,a0,38 # 55f8 <malloc+0xe00>
...
0000000000000606 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    printf("%s: fork claimed to work 1000 times!\n", s);
     ...
     636:	77650513          	addi	a0,a0,1910 # 4da8 <malloc+0x5b0>
  ...
  if(wait(0) != -1){
    ...
    printf("%s: no fork at all!\n", s);
     ...
     698:	6fc50513          	addi	a0,a0,1788 # 4d90 <malloc+0x598>
    ...
    exit(1);
     ...
     6b4:	72050513          	addi	a0,a0,1824 # 4dd0 <malloc+0x5d8>
    ...
    printf("%s: wait got too many\n", s);
     ...
     6d0:	71c50513          	addi	a0,a0,1820 # 4de8 <malloc+0x5f0>
...
00000000000006e6 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
     ...
     750:	5ac50513          	addi	a0,a0,1452 # 4cf8 <malloc+0x500>
     ...
     770:	69450513          	addi	a0,a0,1684 # 4e00 <malloc+0x608>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    printf("%s: stacktest: read below stack %p\n", *sp);
     ...
     7d6:	64e50513          	addi	a0,a0,1614 # 4e20 <malloc+0x628>
    ...
    printf("%s: fork failed\n", s);
     ...
     7f2:	50a50513          	addi	a0,a0,1290 # 4cf8 <malloc+0x500>
...
0000000000000812 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     822:	62a50513          	addi	a0,a0,1578 # 4e48 <malloc+0x650>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     846:	60650513          	addi	a0,a0,1542 # 4e48 <malloc+0x650>
    ...
    if(fd >= 0){
     ...
     85c:	61050513          	addi	a0,a0,1552 # 4e68 <malloc+0x670>
    ...
    printf("%s: mkdir oidir failed\n", s);
     ...
     878:	5dc50513          	addi	a0,a0,1500 # 4e50 <malloc+0x658>
    ...
    printf("%s: fork failed\n", s);
     ...
     894:	46850513          	addi	a0,a0,1128 # 4cf8 <malloc+0x500>
  ...
  if(unlink("oidir") != 0){
     ...
     8c2:	58a50513          	addi	a0,a0,1418 # 4e48 <malloc+0x650>
    ...
    printf("%s: unlink failed\n", s);
     ...
     8d6:	5be50513          	addi	a0,a0,1470 # 4e90 <malloc+0x698>
...
0000000000000904 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     916:	59650513          	addi	a0,a0,1430 # 4ea8 <malloc+0x6b0>
  ...
  fd = open("doesnotexist", 0);
     ...
     934:	59850513          	addi	a0,a0,1432 # 4ec8 <malloc+0x6d0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
     ...
     954:	56050513          	addi	a0,a0,1376 # 4eb0 <malloc+0x6b8>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     970:	56c50513          	addi	a0,a0,1388 # 4ed8 <malloc+0x6e0>
...
0000000000000a1a <forkforkfork>:
{
  ...
  unlink("stopforking");
     ...
     a2a:	4da50513          	addi	a0,a0,1242 # 4f00 <malloc+0x708>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
     ...
     a56:	4ae50513          	addi	a0,a0,1198 # 4f00 <malloc+0x708>
  ...
  sleep(10); // one second
    ...
    printf("%s: fork failed", s);
     ...
     a8e:	2d650513          	addi	a0,a0,726 # 4d60 <malloc+0x568>
    ...
    exit(1);
     ...
     aa8:	45c48493          	addi	s1,s1,1116 # 4f00 <malloc+0x708>
     aac:	4581                	li	a1,0
     aae:	8526                	mv	a0,s1
...
0000000000000aea <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     b58:	aa450513          	addi	a0,a0,-1372 # 55f8 <malloc+0xe00>
     ...
     b84:	39050513          	addi	a0,a0,912 # 4f10 <malloc+0x718>
     ...
     bf6:	29e50513          	addi	a0,a0,670 # 4e90 <malloc+0x698>
     ...
     c2a:	30250513          	addi	a0,a0,770 # 4f28 <malloc+0x730>
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     c90:	2c450513          	addi	a0,a0,708 # 4f50 <malloc+0x758>
...
0000000000000d10 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
     ...
     d20:	42c50513          	addi	a0,a0,1068 # 5148 <malloc+0x950>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
     ...
     d32:	27250513          	addi	a0,a0,626 # 4fa0 <malloc+0x7a8>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
     ...
     d48:	2b450513          	addi	a0,a0,692 # 4ff8 <malloc+0x800>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
     ...
     d66:	30e50513          	addi	a0,a0,782 # 5070 <malloc+0x878>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
     ...
     d82:	36250513          	addi	a0,a0,866 # 50e0 <malloc+0x8e8>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
     ...
     d94:	3a850513          	addi	a0,a0,936 # 5138 <malloc+0x940>
    ...
    printf("%s: mkdir 12345678901234 failed\n", s);
     ...
     db2:	1ca50513          	addi	a0,a0,458 # 4f78 <malloc+0x780>
    ...
    printf("%s: mkdir 12345678901234/123456789012345 failed\n", s);
     ...
     dce:	1f650513          	addi	a0,a0,502 # 4fc0 <malloc+0x7c8>
    ...
    printf("%s: create 123456789012345/123456789012345/123456789012345 failed\n", s);
     ...
     dea:	24250513          	addi	a0,a0,578 # 5028 <malloc+0x830>
    ...
    printf("%s: open 12345678901234/12345678901234/12345678901234 failed\n", s);
     ...
     e06:	29e50513          	addi	a0,a0,670 # 50a0 <malloc+0x8a8>
    ...
    printf("%s: mkdir 12345678901234/12345678901234 succeeded!\n", s);
     ...
     e22:	2e250513          	addi	a0,a0,738 # 5100 <malloc+0x908>
    ...
    printf("%s: mkdir 12345678901234/123456789012345 succeeded!\n", s);
     ...
     e3e:	31e50513          	addi	a0,a0,798 # 5158 <malloc+0x960>
...
0000000000000e54 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     f06:	28e50513          	addi	a0,a0,654 # 5190 <malloc+0x998>
     ...
     f2a:	28a50513          	addi	a0,a0,650 # 51b0 <malloc+0x9b8>
...
0000000000000f40 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     f5e:	26e50513          	addi	a0,a0,622 # 51c8 <malloc+0x9d0>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     f76:	27e98993          	addi	s3,s3,638 # 51f0 <malloc+0x9f8>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     f7a:	00004a97          	auipc	s5,0x4
     f7e:	2aea8a93          	addi	s5,s5,686 # 5228 <malloc+0xa30>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     fc4:	20850513          	addi	a0,a0,520 # 51c8 <malloc+0x9d0>
  ...
  if(unlink("small") < 0){
    ...
    1000:	1cc50513          	addi	a0,a0,460 # 51c8 <malloc+0x9d0>
    ...
    102a:	1aa50513          	addi	a0,a0,426 # 51d0 <malloc+0x9d8>
    ...
    1046:	1be50513          	addi	a0,a0,446 # 5200 <malloc+0xa08>
    ...
    1062:	1da50513          	addi	a0,a0,474 # 5238 <malloc+0xa40>
    ...
    107e:	1e650513          	addi	a0,a0,486 # 5260 <malloc+0xa68>
    ...
    109a:	1ea50513          	addi	a0,a0,490 # 5280 <malloc+0xa88>
    ...
    10b6:	1e650513          	addi	a0,a0,486 # 5298 <malloc+0xaa0>
...
00000000000010cc <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    10e8:	1d450513          	addi	a0,a0,468 # 52b8 <malloc+0xac0>
  ...
  fd = open("big", O_RDONLY);
    ...
    113a:	18250513          	addi	a0,a0,386 # 52b8 <malloc+0xac0>
  ...
  if(fd < 0){
    ...
    1182:	14250513          	addi	a0,a0,322 # 52c0 <malloc+0xac8>
    ...
    119e:	14650513          	addi	a0,a0,326 # 52e0 <malloc+0xae8>
    ...
    11ba:	15250513          	addi	a0,a0,338 # 5308 <malloc+0xb10>
  ...
  if(unlink("big") < 0){
    ...
    11e6:	0d650513          	addi	a0,a0,214 # 52b8 <malloc+0xac0>
    ...
    1210:	11c50513          	addi	a0,a0,284 # 5328 <malloc+0xb30>
    ...
    122c:	12850513          	addi	a0,a0,296 # 5350 <malloc+0xb58>
    ...
    1248:	12450513          	addi	a0,a0,292 # 5368 <malloc+0xb70>
    ...
    1264:	13050513          	addi	a0,a0,304 # 5390 <malloc+0xb98>
...
000000000000127a <unlinkread>:
{
  ...
  write(fd, "hello", SZ);
    ...
    12aa:	12258593          	addi	a1,a1,290 # 53c8 <malloc+0xbd0>
  ...
  write(fd1, "yyy", 3);
    ...
    1306:	10e58593          	addi	a1,a1,270 # 5410 <malloc+0xc18>
  ...
  unlink("unlinkread");
    ...
    138e:	01e50513          	addi	a0,a0,30 # 53a8 <malloc+0xbb0>
    ...
    13aa:	02a50513          	addi	a0,a0,42 # 53d0 <malloc+0xbd8>
    ...
    13c6:	02e50513          	addi	a0,a0,46 # 53f0 <malloc+0xbf8>
    ...
    13e2:	03a50513          	addi	a0,a0,58 # 5418 <malloc+0xc20>
    ...
    13fe:	03e50513          	addi	a0,a0,62 # 5438 <malloc+0xc40>
    ...
    141a:	04250513          	addi	a0,a0,66 # 5458 <malloc+0xc60>
...
0000000000001430 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1442:	a6a78793          	addi	a5,a5,-1430 # 4ea8 <malloc+0x6b0>
    1446:	fcf43023          	sd	a5,-64(s0)
    144a:	00004797          	auipc	a5,0x4
    144e:	02e78793          	addi	a5,a5,46 # 5478 <malloc+0xc80>
    1452:	fcf43423          	sd	a5,-56(s0)
    1456:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    145a:	00004517          	auipc	a0,0x4
    145e:	02650513          	addi	a0,a0,38 # 5480 <malloc+0xc88>
  ...
  if(pid == 0) {
    ...
    148c:	ff850513          	addi	a0,a0,-8 # 5480 <malloc+0xc88>
    ...
    14a8:	fe450513          	addi	a0,a0,-28 # 5488 <malloc+0xc90>
    ...
    14c4:	83850513          	addi	a0,a0,-1992 # 4cf8 <malloc+0x500>
    ...
    14e0:	a3450513          	addi	a0,a0,-1484 # 4f10 <malloc+0x718>
    ...
    14fe:	9ae50513          	addi	a0,a0,-1618 # 4ea8 <malloc+0x6b0>
  ...
  if(xstatus != 0)
    ...
    1532:	f6a50513          	addi	a0,a0,-150 # 5498 <malloc+0xca0>
    ...
    154e:	f6650513          	addi	a0,a0,-154 # 54b0 <malloc+0xcb8>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1562:	f2250513          	addi	a0,a0,-222 # 5480 <malloc+0xc88>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    158c:	cf850513          	addi	a0,a0,-776 # 5280 <malloc+0xa88>
    ...
    15a8:	f2450513          	addi	a0,a0,-220 # 54c8 <malloc+0xcd0>
  ...
  unlink("echo-ok");
    ...
    15c2:	ec250513          	addi	a0,a0,-318 # 5480 <malloc+0xc88>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    15ec:	ef850513          	addi	a0,a0,-264 # 54e0 <malloc+0xce8>
...
000000000000160c <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    161c:	ee050513          	addi	a0,a0,-288 # 54f8 <malloc+0xd00>
  ...
  fd = open("bigarg-ok", 0);
    ...
    164e:	eae50513          	addi	a0,a0,-338 # 54f8 <malloc+0xd00>
  ...
  close(fd);
    ...
    1674:	33878793          	addi	a5,a5,824 # 69a8 <args.0>
    1678:	00005697          	auipc	a3,0x5
    167c:	42868693          	addi	a3,a3,1064 # 6aa0 <args.0+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    1680:	00004717          	auipc	a4,0x4
    1684:	e8870713          	addi	a4,a4,-376 # 5508 <malloc+0xd10>
    ...
    16d8:	f1450513          	addi	a0,a0,-236 # 55e8 <malloc+0xdf0>
    ...
    16fc:	f1050513          	addi	a0,a0,-240 # 5608 <malloc+0xe10>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1730:	77c98993          	addi	s3,s3,1916 # 4ea8 <malloc+0x6b0>
    argv[0] = (char*)0xffffffff;
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17fa:	e3250513          	addi	a0,a0,-462 # 5628 <malloc+0xe30>
    ...
    1834:	42da8a93          	addi	s5,s5,1069 # 142d <unlinkread+0x1b3>
{
    ...
    1880:	dc450513          	addi	a0,a0,-572 # 5640 <malloc+0xe48>
    ...
    189c:	dc050513          	addi	a0,a0,-576 # 5658 <malloc+0xe60>
    ...
    18ce:	da650513          	addi	a0,a0,-602 # 5670 <malloc+0xe78>
    ...
    190e:	d8650513          	addi	a0,a0,-634 # 5690 <malloc+0xe98>
...
000000000000195c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    1984:	3e050513          	addi	a0,a0,992 # 4d60 <malloc+0x568>
  ...
  if(pid2 == 0)
    ...
    19b2:	34a50513          	addi	a0,a0,842 # 4cf8 <malloc+0x500>
  ...
  if(pid3 == 0){
    ...
    19f6:	cb658593          	addi	a1,a1,-842 # 56a8 <malloc+0xeb0>
    ...
    1a20:	2dc50513          	addi	a0,a0,732 # 4cf8 <malloc+0x500>
    ...
    1a3a:	c7a50513          	addi	a0,a0,-902 # 56b0 <malloc+0xeb8>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1a74:	c5850513          	addi	a0,a0,-936 # 56c8 <malloc+0xed0>
  ...
  printf("kill... ");
    ...
    1aa0:	c4450513          	addi	a0,a0,-956 # 56e0 <malloc+0xee8>
  ...
  printf("wait... ");
    ...
    1ace:	c2650513          	addi	a0,a0,-986 # 56f0 <malloc+0xef8>
...
0000000000001afa <reparent>:
{
  ...
  exit(0);
    ...
    1b4e:	1ae50513          	addi	a0,a0,430 # 4cf8 <malloc+0x500>
    ...
    1b6a:	1c250513          	addi	a0,a0,450 # 4d28 <malloc+0x530>
...
0000000000001baa <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    1bbe:	7e0080e7          	jalr	2016(ra) # 439a <fork>
    m1 = 0;
    1bc2:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    1bd0:	00002097          	auipc	ra,0x2
    1bd4:	7da080e7          	jalr	2010(ra) # 43aa <wait>
    exit(xstatus);
    1bd8:	fcc42503          	lw	a0,-52(s0)
    1bdc:	00002097          	auipc	ra,0x2
    1be0:	7c6080e7          	jalr	1990(ra) # 43a2 <exit>
      *(char**)m2 = m1;
    ...
    1bee:	c0e080e7          	jalr	-1010(ra) # 47f8 <malloc>
    ...
    1bfe:	b76080e7          	jalr	-1162(ra) # 4770 <free>
    while(m1){
    1c02:	f8f5                	bnez	s1,1bf6 <mem+0x4c>
    m1 = malloc(1024*20);
    1c04:	6515                	lui	a0,0x5
    1c06:	00003097          	auipc	ra,0x3
    1c0a:	bf2080e7          	jalr	-1038(ra) # 47f8 <malloc>
    if(m1 == 0){
    1c0e:	c911                	beqz	a0,1c22 <mem+0x78>
    free(m1);
    1c10:	00003097          	auipc	ra,0x3
    1c14:	b60080e7          	jalr	-1184(ra) # 4770 <free>
    exit(0);
    1c18:	4501                	li	a0,0
    1c1a:	00002097          	auipc	ra,0x2
    1c1e:	788080e7          	jalr	1928(ra) # 43a2 <exit>
      printf("couldn't allocate mem?!!\n", s);
    1c22:	85ce                	mv	a1,s3
    1c24:	00004517          	auipc	a0,0x4
    1c28:	adc50513          	addi	a0,a0,-1316 # 5700 <malloc+0xf08>
    1c2c:	00003097          	auipc	ra,0x3
    1c30:	b0e080e7          	jalr	-1266(ra) # 473a <printf>
      exit(1);
    1c34:	4505                	li	a0,1
    1c36:	00002097          	auipc	ra,0x2
    1c3a:	76c080e7          	jalr	1900(ra) # 43a2 <exit>
...
0000000000001c3e <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    1c5a:	d9250513          	addi	a0,a0,-622 # 49e8 <malloc+0x1f0>
    1c5e:	00002097          	auipc	ra,0x2
    1c62:	794080e7          	jalr	1940(ra) # 43f2 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    1c66:	20200593          	li	a1,514
    1c6a:	00003517          	auipc	a0,0x3
    1c6e:	d7e50513          	addi	a0,a0,-642 # 49e8 <malloc+0x1f0>
    1c72:	00002097          	auipc	ra,0x2
    1c76:	770080e7          	jalr	1904(ra) # 43e2 <open>
  if(fd < 0){
    1c7a:	04054a63          	bltz	a0,1cce <sharedfd+0x90>
    1c7e:	892a                	mv	s2,a0
  pid = fork();
    1c80:	00002097          	auipc	ra,0x2
    1c84:	71a080e7          	jalr	1818(ra) # 439a <fork>
    1c88:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    1cb2:	714080e7          	jalr	1812(ra) # 43c2 <write>
    1cb6:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    1cca:	6dc080e7          	jalr	1756(ra) # 43a2 <exit>
    printf("%s: cannot open sharedfd for writing", s);
    1cce:	85d2                	mv	a1,s4
    1cd0:	00004517          	auipc	a0,0x4
    1cd4:	a5050513          	addi	a0,a0,-1456 # 5720 <malloc+0xf28>
    1cd8:	00003097          	auipc	ra,0x3
    1cdc:	a62080e7          	jalr	-1438(ra) # 473a <printf>
    exit(1);
    1ce0:	4505                	li	a0,1
    1ce2:	00002097          	auipc	ra,0x2
    1ce6:	6c0080e7          	jalr	1728(ra) # 43a2 <exit>
      printf("%s: write sharedfd failed\n", s);
    1cea:	85d2                	mv	a1,s4
    1cec:	00004517          	auipc	a0,0x4
    1cf0:	a5c50513          	addi	a0,a0,-1444 # 5748 <malloc+0xf50>
    1cf4:	00003097          	auipc	ra,0x3
    1cf8:	a46080e7          	jalr	-1466(ra) # 473a <printf>
      exit(1);
    1cfc:	4505                	li	a0,1
    1cfe:	00002097          	auipc	ra,0x2
    1d02:	6a4080e7          	jalr	1700(ra) # 43a2 <exit>
    wait(&xstatus);
    1d06:	f9c40513          	addi	a0,s0,-100
    1d0a:	00002097          	auipc	ra,0x2
    1d0e:	6a0080e7          	jalr	1696(ra) # 43aa <wait>
    if(xstatus != 0)
    ...
    1d20:	686080e7          	jalr	1670(ra) # 43a2 <exit>
  close(fd);
    1d24:	854a                	mv	a0,s2
    1d26:	00002097          	auipc	ra,0x2
    1d2a:	6a4080e7          	jalr	1700(ra) # 43ca <close>
  fd = open("sharedfd", 0);
    1d2e:	4581                	li	a1,0
    1d30:	00003517          	auipc	a0,0x3
    1d34:	cb850513          	addi	a0,a0,-840 # 49e8 <malloc+0x1f0>
    1d38:	00002097          	auipc	ra,0x2
    1d3c:	6aa080e7          	jalr	1706(ra) # 43e2 <open>
    1d40:	8baa                	mv	s7,a0
  nc = np = 0;
    1d42:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1d60:	65e080e7          	jalr	1630(ra) # 43ba <read>
    ...
    1d74:	9f850513          	addi	a0,a0,-1544 # 5768 <malloc+0xf70>
    1d78:	00003097          	auipc	ra,0x3
    1d7c:	9c2080e7          	jalr	-1598(ra) # 473a <printf>
    exit(1);
    1d80:	4505                	li	a0,1
    1d82:	00002097          	auipc	ra,0x2
    1d86:	620080e7          	jalr	1568(ra) # 43a2 <exit>
        nc++;
  ...
  close(fd);
    ...
    1da8:	626080e7          	jalr	1574(ra) # 43ca <close>
  unlink("sharedfd");
    1dac:	00003517          	auipc	a0,0x3
    1db0:	c3c50513          	addi	a0,a0,-964 # 49e8 <malloc+0x1f0>
    1db4:	00002097          	auipc	ra,0x2
    1db8:	63e080e7          	jalr	1598(ra) # 43f2 <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    1dd6:	9be50513          	addi	a0,a0,-1602 # 5790 <malloc+0xf98>
    1dda:	00003097          	auipc	ra,0x3
    1dde:	960080e7          	jalr	-1696(ra) # 473a <printf>
    exit(1);
    1de2:	4505                	li	a0,1
    1de4:	00002097          	auipc	ra,0x2
    1de8:	5be080e7          	jalr	1470(ra) # 43a2 <exit>
    exit(0);
    1dec:	4501                	li	a0,0
    1dee:	00002097          	auipc	ra,0x2
    1df2:	5b4080e7          	jalr	1460(ra) # 43a2 <exit>
...
0000000000001df6 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    1e1c:	ac878793          	addi	a5,a5,-1336 # 48e0 <malloc+0xe8>
    1e20:	f6f43823          	sd	a5,-144(s0)
    1e24:	00003797          	auipc	a5,0x3
    1e28:	ac478793          	addi	a5,a5,-1340 # 48e8 <malloc+0xf0>
    1e2c:	f6f43c23          	sd	a5,-136(s0)
    1e30:	00003797          	auipc	a5,0x3
    1e34:	ac078793          	addi	a5,a5,-1344 # 48f0 <malloc+0xf8>
    1e38:	f8f43023          	sd	a5,-128(s0)
    1e3c:	00003797          	auipc	a5,0x3
    1e40:	abc78793          	addi	a5,a5,-1348 # 48f8 <malloc+0x100>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1e5c:	59a080e7          	jalr	1434(ra) # 43f2 <unlink>
    pid = fork();
    1e60:	00002097          	auipc	ra,0x2
    1e64:	53a080e7          	jalr	1338(ra) # 439a <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1e80:	52e080e7          	jalr	1326(ra) # 43aa <wait>
    if(xstatus != 0)
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1e98:	324a0a13          	addi	s4,s4,804 # 91b8 <buf>
    1e9c:	00007a97          	auipc	s5,0x7
    1ea0:	31da8a93          	addi	s5,s5,797 # 91b9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    1eb8:	74450513          	addi	a0,a0,1860 # 55f8 <malloc+0xe00>
    1ebc:	00003097          	auipc	ra,0x3
    1ec0:	87e080e7          	jalr	-1922(ra) # 473a <printf>
      exit(1);
    1ec4:	4505                	li	a0,1
    1ec6:	00002097          	auipc	ra,0x2
    1eca:	4dc080e7          	jalr	1244(ra) # 43a2 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1ece:	20200593          	li	a1,514
    1ed2:	854e                	mv	a0,s3
    1ed4:	00002097          	auipc	ra,0x2
    1ed8:	50e080e7          	jalr	1294(ra) # 43e2 <open>
    1edc:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    1f10:	4b6080e7          	jalr	1206(ra) # 43c2 <write>
    1f14:	85aa                	mv	a1,a0
    ...
    1f28:	47e080e7          	jalr	1150(ra) # 43a2 <exit>
        printf("create failed\n", s);
    1f2c:	f5843583          	ld	a1,-168(s0)
    1f30:	00004517          	auipc	a0,0x4
    1f34:	87850513          	addi	a0,a0,-1928 # 57a8 <malloc+0xfb0>
    1f38:	00003097          	auipc	ra,0x3
    1f3c:	802080e7          	jalr	-2046(ra) # 473a <printf>
        exit(1);
    1f40:	4505                	li	a0,1
    1f42:	00002097          	auipc	ra,0x2
    1f46:	460080e7          	jalr	1120(ra) # 43a2 <exit>
          printf("write failed %d\n", n);
    1f4a:	00004517          	auipc	a0,0x4
    1f4e:	86e50513          	addi	a0,a0,-1938 # 57b8 <malloc+0xfc0>
    1f52:	00002097          	auipc	ra,0x2
    1f56:	7e8080e7          	jalr	2024(ra) # 473a <printf>
          exit(1);
    1f5a:	4505                	li	a0,1
    1f5c:	00002097          	auipc	ra,0x2
    1f60:	446080e7          	jalr	1094(ra) # 43a2 <exit>
      exit(xstatus);
    1f64:	855a                	mv	a0,s6
    1f66:	00002097          	auipc	ra,0x2
    1f6a:	43c080e7          	jalr	1084(ra) # 43a2 <exit>
          printf("wrong char\n", s);
    1f6e:	f5843583          	ld	a1,-168(s0)
    1f72:	00004517          	auipc	a0,0x4
    1f76:	85e50513          	addi	a0,a0,-1954 # 57d0 <malloc+0xfd8>
    1f7a:	00002097          	auipc	ra,0x2
    1f7e:	7c0080e7          	jalr	1984(ra) # 473a <printf>
          exit(1);
    1f82:	4505                	li	a0,1
    1f84:	00002097          	auipc	ra,0x2
    1f88:	41e080e7          	jalr	1054(ra) # 43a2 <exit>
      total += n;
    ...
    1f9a:	424080e7          	jalr	1060(ra) # 43ba <read>
    1f9e:	02a05363          	blez	a0,1fc4 <fourfiles+0x1ce>
    1fa2:	00007797          	auipc	a5,0x7
    1fa6:	21678793          	addi	a5,a5,534 # 91b8 <buf>
    ...
    1fca:	404080e7          	jalr	1028(ra) # 43ca <close>
    if(total != N*SZ){
    1fce:	03b91863          	bne	s2,s11,1ffe <fourfiles+0x208>
    unlink(fname);
    1fd2:	8566                	mv	a0,s9
    1fd4:	00002097          	auipc	ra,0x2
    1fd8:	41e080e7          	jalr	1054(ra) # 43f2 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    1ff0:	3f6080e7          	jalr	1014(ra) # 43e2 <open>
    1ff4:	89aa                	mv	s3,a0
    total = 0;
    1ff6:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    1ffe:	85ca                	mv	a1,s2
    2000:	00003517          	auipc	a0,0x3
    2004:	7e050513          	addi	a0,a0,2016 # 57e0 <malloc+0xfe8>
    2008:	00002097          	auipc	ra,0x2
    200c:	732080e7          	jalr	1842(ra) # 473a <printf>
      exit(1);
    2010:	4505                	li	a0,1
    2012:	00002097          	auipc	ra,0x2
    2016:	390080e7          	jalr	912(ra) # 43a2 <exit>
}
...
0000000000002038 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    2050:	aec50513          	addi	a0,a0,-1300 # 4b38 <malloc+0x340>
    2054:	00002097          	auipc	ra,0x2
    2058:	39e080e7          	jalr	926(ra) # 43f2 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    205c:	20200593          	li	a1,514
    2060:	00003517          	auipc	a0,0x3
    2064:	ad850513          	addi	a0,a0,-1320 # 4b38 <malloc+0x340>
    2068:	00002097          	auipc	ra,0x2
    206c:	37a080e7          	jalr	890(ra) # 43e2 <open>
    2070:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    2072:	4481                	li	s1,0
    memset(buf, i, SZ);
    2074:	00007917          	auipc	s2,0x7
    2078:	14490913          	addi	s2,s2,324 # 91b8 <buf>
  for(i = 0; i < N; i++){
    207c:	4a51                	li	s4,20
  if(fd < 0){
    ...
    209e:	328080e7          	jalr	808(ra) # 43c2 <write>
  ...
  close(fd);
    ...
    20b6:	318080e7          	jalr	792(ra) # 43ca <close>
  fd = open("bigfile", 0);
    20ba:	4581                	li	a1,0
    20bc:	00003517          	auipc	a0,0x3
    20c0:	a7c50513          	addi	a0,a0,-1412 # 4b38 <malloc+0x340>
    20c4:	00002097          	auipc	ra,0x2
    20c8:	31e080e7          	jalr	798(ra) # 43e2 <open>
    20cc:	8a2a                	mv	s4,a0
  total = 0;
    20ce:	4981                	li	s3,0
  for(i = 0; ; i++){
    ...
    20d6:	0e690913          	addi	s2,s2,230 # 91b8 <buf>
  if(fd < 0){
    ...
    20ea:	2d4080e7          	jalr	724(ra) # 43ba <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    2124:	6d850513          	addi	a0,a0,1752 # 57f8 <malloc+0x1000>
    2128:	00002097          	auipc	ra,0x2
    212c:	612080e7          	jalr	1554(ra) # 473a <printf>
    exit(1);
    2130:	4505                	li	a0,1
    2132:	00002097          	auipc	ra,0x2
    2136:	270080e7          	jalr	624(ra) # 43a2 <exit>
      printf("%s: write bigfile failed\n", s);
    213a:	85d6                	mv	a1,s5
    213c:	00003517          	auipc	a0,0x3
    2140:	6dc50513          	addi	a0,a0,1756 # 5818 <malloc+0x1020>
    2144:	00002097          	auipc	ra,0x2
    2148:	5f6080e7          	jalr	1526(ra) # 473a <printf>
      exit(1);
    214c:	4505                	li	a0,1
    214e:	00002097          	auipc	ra,0x2
    2152:	254080e7          	jalr	596(ra) # 43a2 <exit>
    printf("%s: cannot open bigfile\n", s);
    2156:	85d6                	mv	a1,s5
    2158:	00003517          	auipc	a0,0x3
    215c:	6e050513          	addi	a0,a0,1760 # 5838 <malloc+0x1040>
    2160:	00002097          	auipc	ra,0x2
    2164:	5da080e7          	jalr	1498(ra) # 473a <printf>
    exit(1);
    2168:	4505                	li	a0,1
    216a:	00002097          	auipc	ra,0x2
    216e:	238080e7          	jalr	568(ra) # 43a2 <exit>
      printf("%s: read bigfile failed\n", s);
    2172:	85d6                	mv	a1,s5
    2174:	00003517          	auipc	a0,0x3
    2178:	6e450513          	addi	a0,a0,1764 # 5858 <malloc+0x1060>
    217c:	00002097          	auipc	ra,0x2
    2180:	5be080e7          	jalr	1470(ra) # 473a <printf>
      exit(1);
    2184:	4505                	li	a0,1
    2186:	00002097          	auipc	ra,0x2
    218a:	21c080e7          	jalr	540(ra) # 43a2 <exit>
      printf("%s: short read bigfile\n", s);
    218e:	85d6                	mv	a1,s5
    2190:	00003517          	auipc	a0,0x3
    2194:	6e850513          	addi	a0,a0,1768 # 5878 <malloc+0x1080>
    2198:	00002097          	auipc	ra,0x2
    219c:	5a2080e7          	jalr	1442(ra) # 473a <printf>
      exit(1);
    21a0:	4505                	li	a0,1
    21a2:	00002097          	auipc	ra,0x2
    21a6:	200080e7          	jalr	512(ra) # 43a2 <exit>
      printf("%s: read bigfile wrong data\n", s);
    21aa:	85d6                	mv	a1,s5
    21ac:	00003517          	auipc	a0,0x3
    21b0:	6e450513          	addi	a0,a0,1764 # 5890 <malloc+0x1098>
    21b4:	00002097          	auipc	ra,0x2
    21b8:	586080e7          	jalr	1414(ra) # 473a <printf>
      exit(1);
    21bc:	4505                	li	a0,1
    21be:	00002097          	auipc	ra,0x2
    21c2:	1e4080e7          	jalr	484(ra) # 43a2 <exit>
  close(fd);
    21c6:	8552                	mv	a0,s4
    21c8:	00002097          	auipc	ra,0x2
    21cc:	202080e7          	jalr	514(ra) # 43ca <close>
  if(total != N*SZ){
  ...
  unlink("bigfile");
    ...
    21de:	95e50513          	addi	a0,a0,-1698 # 4b38 <malloc+0x340>
    21e2:	00002097          	auipc	ra,0x2
    21e6:	210080e7          	jalr	528(ra) # 43f2 <unlink>
}
    ...
    2202:	6b250513          	addi	a0,a0,1714 # 58b0 <malloc+0x10b8>
    2206:	00002097          	auipc	ra,0x2
    220a:	534080e7          	jalr	1332(ra) # 473a <printf>
    exit(1);
    220e:	4505                	li	a0,1
    2210:	00002097          	auipc	ra,0x2
    2214:	192080e7          	jalr	402(ra) # 43a2 <exit>
...
0000000000002218 <linktest>:
{
  ...
  unlink("lf1");
    ...
    222a:	6aa50513          	addi	a0,a0,1706 # 58d0 <malloc+0x10d8>
    222e:	00002097          	auipc	ra,0x2
    2232:	1c4080e7          	jalr	452(ra) # 43f2 <unlink>
  unlink("lf2");
    2236:	00003517          	auipc	a0,0x3
    223a:	6a250513          	addi	a0,a0,1698 # 58d8 <malloc+0x10e0>
    223e:	00002097          	auipc	ra,0x2
    2242:	1b4080e7          	jalr	436(ra) # 43f2 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    2246:	20200593          	li	a1,514
    224a:	00003517          	auipc	a0,0x3
    224e:	68650513          	addi	a0,a0,1670 # 58d0 <malloc+0x10d8>
    2252:	00002097          	auipc	ra,0x2
    2256:	190080e7          	jalr	400(ra) # 43e2 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    2266:	16658593          	addi	a1,a1,358 # 53c8 <malloc+0xbd0>
    226a:	00002097          	auipc	ra,0x2
    226e:	158080e7          	jalr	344(ra) # 43c2 <write>
    2272:	4795                	li	a5,5
    2274:	10f51863          	bne	a0,a5,2384 <linktest+0x16c>
  close(fd);
    2278:	8526                	mv	a0,s1
    227a:	00002097          	auipc	ra,0x2
    227e:	150080e7          	jalr	336(ra) # 43ca <close>
  if(link("lf1", "lf2") < 0){
    2282:	00003597          	auipc	a1,0x3
    2286:	65658593          	addi	a1,a1,1622 # 58d8 <malloc+0x10e0>
    228a:	00003517          	auipc	a0,0x3
    228e:	64650513          	addi	a0,a0,1606 # 58d0 <malloc+0x10d8>
    2292:	00002097          	auipc	ra,0x2
    2296:	170080e7          	jalr	368(ra) # 4402 <link>
    229a:	10054363          	bltz	a0,23a0 <linktest+0x188>
  unlink("lf1");
    229e:	00003517          	auipc	a0,0x3
    22a2:	63250513          	addi	a0,a0,1586 # 58d0 <malloc+0x10d8>
    22a6:	00002097          	auipc	ra,0x2
    22aa:	14c080e7          	jalr	332(ra) # 43f2 <unlink>
  if(open("lf1", 0) >= 0){
    22ae:	4581                	li	a1,0
    22b0:	00003517          	auipc	a0,0x3
    22b4:	62050513          	addi	a0,a0,1568 # 58d0 <malloc+0x10d8>
    22b8:	00002097          	auipc	ra,0x2
    22bc:	12a080e7          	jalr	298(ra) # 43e2 <open>
    22c0:	0e055e63          	bgez	a0,23bc <linktest+0x1a4>
  fd = open("lf2", 0);
    22c4:	4581                	li	a1,0
    22c6:	00003517          	auipc	a0,0x3
    22ca:	61250513          	addi	a0,a0,1554 # 58d8 <malloc+0x10e0>
    22ce:	00002097          	auipc	ra,0x2
    22d2:	114080e7          	jalr	276(ra) # 43e2 <open>
    22d6:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    22e2:	eda58593          	addi	a1,a1,-294 # 91b8 <buf>
    22e6:	00002097          	auipc	ra,0x2
    22ea:	0d4080e7          	jalr	212(ra) # 43ba <read>
    22ee:	4795                	li	a5,5
    22f0:	10f51263          	bne	a0,a5,23f4 <linktest+0x1dc>
  close(fd);
    22f4:	8526                	mv	a0,s1
    22f6:	00002097          	auipc	ra,0x2
    22fa:	0d4080e7          	jalr	212(ra) # 43ca <close>
  if(link("lf2", "lf2") >= 0){
    22fe:	00003597          	auipc	a1,0x3
    2302:	5da58593          	addi	a1,a1,1498 # 58d8 <malloc+0x10e0>
    2306:	852e                	mv	a0,a1
    2308:	00002097          	auipc	ra,0x2
    230c:	0fa080e7          	jalr	250(ra) # 4402 <link>
    2310:	10055063          	bgez	a0,2410 <linktest+0x1f8>
  unlink("lf2");
    2314:	00003517          	auipc	a0,0x3
    2318:	5c450513          	addi	a0,a0,1476 # 58d8 <malloc+0x10e0>
    231c:	00002097          	auipc	ra,0x2
    2320:	0d6080e7          	jalr	214(ra) # 43f2 <unlink>
  if(link("lf2", "lf1") >= 0){
    2324:	00003597          	auipc	a1,0x3
    2328:	5ac58593          	addi	a1,a1,1452 # 58d0 <malloc+0x10d8>
    232c:	00003517          	auipc	a0,0x3
    2330:	5ac50513          	addi	a0,a0,1452 # 58d8 <malloc+0x10e0>
    2334:	00002097          	auipc	ra,0x2
    2338:	0ce080e7          	jalr	206(ra) # 4402 <link>
    233c:	0e055863          	bgez	a0,242c <linktest+0x214>
  if(link(".", "lf1") >= 0){
    2340:	00003597          	auipc	a1,0x3
    2344:	59058593          	addi	a1,a1,1424 # 58d0 <malloc+0x10d8>
    2348:	00003517          	auipc	a0,0x3
    234c:	90050513          	addi	a0,a0,-1792 # 4c48 <malloc+0x450>
    2350:	00002097          	auipc	ra,0x2
    2354:	0b2080e7          	jalr	178(ra) # 4402 <link>
    ...
    236e:	57650513          	addi	a0,a0,1398 # 58e0 <malloc+0x10e8>
    2372:	00002097          	auipc	ra,0x2
    2376:	3c8080e7          	jalr	968(ra) # 473a <printf>
    exit(1);
    237a:	4505                	li	a0,1
    237c:	00002097          	auipc	ra,0x2
    2380:	026080e7          	jalr	38(ra) # 43a2 <exit>
    printf("%s: write lf1 failed\n", s);
    2384:	85ca                	mv	a1,s2
    2386:	00003517          	auipc	a0,0x3
    238a:	57250513          	addi	a0,a0,1394 # 58f8 <malloc+0x1100>
    238e:	00002097          	auipc	ra,0x2
    2392:	3ac080e7          	jalr	940(ra) # 473a <printf>
    exit(1);
    2396:	4505                	li	a0,1
    2398:	00002097          	auipc	ra,0x2
    239c:	00a080e7          	jalr	10(ra) # 43a2 <exit>
    printf("%s: link lf1 lf2 failed\n", s);
    23a0:	85ca                	mv	a1,s2
    23a2:	00003517          	auipc	a0,0x3
    23a6:	56e50513          	addi	a0,a0,1390 # 5910 <malloc+0x1118>
    23aa:	00002097          	auipc	ra,0x2
    23ae:	390080e7          	jalr	912(ra) # 473a <printf>
    exit(1);
    23b2:	4505                	li	a0,1
    23b4:	00002097          	auipc	ra,0x2
    23b8:	fee080e7          	jalr	-18(ra) # 43a2 <exit>
    printf("%s: unlinked lf1 but it is still there!\n", s);
    23bc:	85ca                	mv	a1,s2
    23be:	00003517          	auipc	a0,0x3
    23c2:	57250513          	addi	a0,a0,1394 # 5930 <malloc+0x1138>
    23c6:	00002097          	auipc	ra,0x2
    23ca:	374080e7          	jalr	884(ra) # 473a <printf>
    exit(1);
    23ce:	4505                	li	a0,1
    23d0:	00002097          	auipc	ra,0x2
    23d4:	fd2080e7          	jalr	-46(ra) # 43a2 <exit>
    printf("%s: open lf2 failed\n", s);
    23d8:	85ca                	mv	a1,s2
    23da:	00003517          	auipc	a0,0x3
    23de:	58650513          	addi	a0,a0,1414 # 5960 <malloc+0x1168>
    23e2:	00002097          	auipc	ra,0x2
    23e6:	358080e7          	jalr	856(ra) # 473a <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    23ec:	00002097          	auipc	ra,0x2
    23f0:	fb6080e7          	jalr	-74(ra) # 43a2 <exit>
    printf("%s: read lf2 failed\n", s);
    23f4:	85ca                	mv	a1,s2
    23f6:	00003517          	auipc	a0,0x3
    23fa:	58250513          	addi	a0,a0,1410 # 5978 <malloc+0x1180>
    23fe:	00002097          	auipc	ra,0x2
    2402:	33c080e7          	jalr	828(ra) # 473a <printf>
    exit(1);
    2406:	4505                	li	a0,1
    2408:	00002097          	auipc	ra,0x2
    240c:	f9a080e7          	jalr	-102(ra) # 43a2 <exit>
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
    2410:	85ca                	mv	a1,s2
    2412:	00003517          	auipc	a0,0x3
    2416:	57e50513          	addi	a0,a0,1406 # 5990 <malloc+0x1198>
    241a:	00002097          	auipc	ra,0x2
    241e:	320080e7          	jalr	800(ra) # 473a <printf>
    exit(1);
    2422:	4505                	li	a0,1
    2424:	00002097          	auipc	ra,0x2
    2428:	f7e080e7          	jalr	-130(ra) # 43a2 <exit>
    printf("%s: link non-existant succeeded! oops\n", s);
    242c:	85ca                	mv	a1,s2
    242e:	00003517          	auipc	a0,0x3
    2432:	58a50513          	addi	a0,a0,1418 # 59b8 <malloc+0x11c0>
    2436:	00002097          	auipc	ra,0x2
    243a:	304080e7          	jalr	772(ra) # 473a <printf>
    exit(1);
    243e:	4505                	li	a0,1
    2440:	00002097          	auipc	ra,0x2
    2444:	f62080e7          	jalr	-158(ra) # 43a2 <exit>
    printf("%s: link . lf1 succeeded! oops\n", s);
    2448:	85ca                	mv	a1,s2
    244a:	00003517          	auipc	a0,0x3
    244e:	59650513          	addi	a0,a0,1430 # 59e0 <malloc+0x11e8>
    2452:	00002097          	auipc	ra,0x2
    2456:	2e8080e7          	jalr	744(ra) # 473a <printf>
    exit(1);
    245a:	4505                	li	a0,1
    245c:	00002097          	auipc	ra,0x2
    2460:	f46080e7          	jalr	-186(ra) # 43a2 <exit>
...
0000000000002464 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    2492:	572b8b93          	addi	s7,s7,1394 # 5a00 <malloc+0x1208>
  for(i = 0; i < N; i++){
    ...
    24a6:	f60080e7          	jalr	-160(ra) # 4402 <link>
    if(pid == 0) {
    ...
    24c4:	f22080e7          	jalr	-222(ra) # 43e2 <open>
      if(fd < 0){
    24c8:	22055963          	bgez	a0,26fa <concreate+0x296>
        printf("concreate create %s failed\n", file);
    24cc:	fa840593          	addi	a1,s0,-88
    24d0:	00003517          	auipc	a0,0x3
    24d4:	53850513          	addi	a0,a0,1336 # 5a08 <malloc+0x1210>
    24d8:	00002097          	auipc	ra,0x2
    24dc:	262080e7          	jalr	610(ra) # 473a <printf>
        exit(1);
    24e0:	4505                	li	a0,1
    24e2:	00002097          	auipc	ra,0x2
    24e6:	ec0080e7          	jalr	-320(ra) # 43a2 <exit>
      link("C0", file);
    24ea:	fa840593          	addi	a1,s0,-88
    24ee:	00003517          	auipc	a0,0x3
    24f2:	51250513          	addi	a0,a0,1298 # 5a00 <malloc+0x1208>
    24f6:	00002097          	auipc	ra,0x2
    24fa:	f0c080e7          	jalr	-244(ra) # 4402 <link>
      exit(0);
    24fe:	4501                	li	a0,0
    2500:	00002097          	auipc	ra,0x2
    2504:	ea2080e7          	jalr	-350(ra) # 43a2 <exit>
        exit(1);
    2508:	4505                	li	a0,1
    250a:	00002097          	auipc	ra,0x2
    250e:	e98080e7          	jalr	-360(ra) # 43a2 <exit>
  ...
  fd = open(".", 0);
    ...
    252a:	72250513          	addi	a0,a0,1826 # 4c48 <malloc+0x450>
    252e:	00002097          	auipc	ra,0x2
    2532:	eb4080e7          	jalr	-332(ra) # 43e2 <open>
    2536:	892a                	mv	s2,a0
  n = 0;
    2538:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    2550:	e6e080e7          	jalr	-402(ra) # 43ba <read>
    ...
    25a0:	48c50513          	addi	a0,a0,1164 # 5a28 <malloc+0x1230>
    25a4:	00002097          	auipc	ra,0x2
    25a8:	196080e7          	jalr	406(ra) # 473a <printf>
        exit(1);
    25ac:	4505                	li	a0,1
    25ae:	00002097          	auipc	ra,0x2
    25b2:	df4080e7          	jalr	-524(ra) # 43a2 <exit>
        printf("%s: concreate duplicate file %s\n", s, de.name);
    25b6:	f7240613          	addi	a2,s0,-142
    25ba:	85ce                	mv	a1,s3
    25bc:	00003517          	auipc	a0,0x3
    25c0:	48c50513          	addi	a0,a0,1164 # 5a48 <malloc+0x1250>
    25c4:	00002097          	auipc	ra,0x2
    25c8:	176080e7          	jalr	374(ra) # 473a <printf>
        exit(1);
    25cc:	4505                	li	a0,1
    25ce:	00002097          	auipc	ra,0x2
    25d2:	dd4080e7          	jalr	-556(ra) # 43a2 <exit>
  close(fd);
    25d6:	854a                	mv	a0,s2
    25d8:	00002097          	auipc	ra,0x2
    25dc:	df2080e7          	jalr	-526(ra) # 43ca <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    25f8:	47c50513          	addi	a0,a0,1148 # 5a70 <malloc+0x1278>
    25fc:	00002097          	auipc	ra,0x2
    2600:	13e080e7          	jalr	318(ra) # 473a <printf>
    exit(1);
    2604:	4505                	li	a0,1
    2606:	00002097          	auipc	ra,0x2
    260a:	d9c080e7          	jalr	-612(ra) # 43a2 <exit>
      printf("%s: fork failed\n", s);
    260e:	85ce                	mv	a1,s3
    2610:	00002517          	auipc	a0,0x2
    2614:	6e850513          	addi	a0,a0,1768 # 4cf8 <malloc+0x500>
    2618:	00002097          	auipc	ra,0x2
    261c:	122080e7          	jalr	290(ra) # 473a <printf>
      exit(1);
    2620:	4505                	li	a0,1
    2622:	00002097          	auipc	ra,0x2
    2626:	d80080e7          	jalr	-640(ra) # 43a2 <exit>
      close(open(file, 0));
    262a:	4581                	li	a1,0
    262c:	fa840513          	addi	a0,s0,-88
    2630:	00002097          	auipc	ra,0x2
    2634:	db2080e7          	jalr	-590(ra) # 43e2 <open>
    2638:	00002097          	auipc	ra,0x2
    263c:	d92080e7          	jalr	-622(ra) # 43ca <close>
      close(open(file, 0));
    2640:	4581                	li	a1,0
    2642:	fa840513          	addi	a0,s0,-88
    2646:	00002097          	auipc	ra,0x2
    264a:	d9c080e7          	jalr	-612(ra) # 43e2 <open>
    264e:	00002097          	auipc	ra,0x2
    2652:	d7c080e7          	jalr	-644(ra) # 43ca <close>
      close(open(file, 0));
    2656:	4581                	li	a1,0
    2658:	fa840513          	addi	a0,s0,-88
    265c:	00002097          	auipc	ra,0x2
    2660:	d86080e7          	jalr	-634(ra) # 43e2 <open>
    2664:	00002097          	auipc	ra,0x2
    2668:	d66080e7          	jalr	-666(ra) # 43ca <close>
      close(open(file, 0));
    266c:	4581                	li	a1,0
    266e:	fa840513          	addi	a0,s0,-88
    2672:	00002097          	auipc	ra,0x2
    2676:	d70080e7          	jalr	-656(ra) # 43e2 <open>
    267a:	00002097          	auipc	ra,0x2
    267e:	d50080e7          	jalr	-688(ra) # 43ca <close>
    if(pid == 0)
    2682:	06090763          	beqz	s2,26f0 <concreate+0x28c>
      wait(0);
    2686:	4501                	li	a0,0
    2688:	00002097          	auipc	ra,0x2
    268c:	d22080e7          	jalr	-734(ra) # 43aa <wait>
  for(i = 0; i < N; i++){
    ...
    26a2:	cfc080e7          	jalr	-772(ra) # 439a <fork>
    26a6:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    2736:	cc0080e7          	jalr	-832(ra) # 43f2 <unlink>
    pid = fork();
    273a:	00002097          	auipc	ra,0x2
    273e:	c60080e7          	jalr	-928(ra) # 439a <fork>
    if(pid && (i % 3) == 1){
    ...
    275a:	c8c080e7          	jalr	-884(ra) # 43e2 <open>
      if(fd < 0){
...
000000000000277a <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    27d6:	ed6a8a93          	addi	s5,s5,-298 # 56a8 <malloc+0xeb0>
      link("cat", "x");
    27da:	00003b97          	auipc	s7,0x3
    27de:	2ceb8b93          	addi	s7,s7,718 # 5aa8 <malloc+0x12b0>
    27e2:	a825                	j	281a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    27e4:	85a6                	mv	a1,s1
    27e6:	00002517          	auipc	a0,0x2
    27ea:	51250513          	addi	a0,a0,1298 # 4cf8 <malloc+0x500>
    27ee:	00002097          	auipc	ra,0x2
    27f2:	f4c080e7          	jalr	-180(ra) # 473a <printf>
    exit(1);
    27f6:	4505                	li	a0,1
    27f8:	00002097          	auipc	ra,0x2
    27fc:	baa080e7          	jalr	-1110(ra) # 43a2 <exit>
      close(open("x", O_RDWR | O_CREATE));
    2800:	20200593          	li	a1,514
    2804:	8556                	mv	a0,s5
    2806:	00002097          	auipc	ra,0x2
    280a:	bdc080e7          	jalr	-1060(ra) # 43e2 <open>
    280e:	00002097          	auipc	ra,0x2
    2812:	bbc080e7          	jalr	-1092(ra) # 43ca <close>
  for(i = 0; i < 100; i++){
    ...
    2836:	bc0080e7          	jalr	-1088(ra) # 43f2 <unlink>
    283a:	bff1                	j	2816 <linkunlink+0x9c>
      link("cat", "x");
    283c:	85d6                	mv	a1,s5
    283e:	855e                	mv	a0,s7
    2840:	00002097          	auipc	ra,0x2
    2844:	bc2080e7          	jalr	-1086(ra) # 4402 <link>
  ...
  if(pid)
    ...
    2854:	b5a080e7          	jalr	-1190(ra) # 43aa <wait>
}
    ...
    2878:	b2e080e7          	jalr	-1234(ra) # 43a2 <exit>
...
000000000000287c <bigdir>:
{
  ...
  unlink("bd");
    ...
    2896:	21e50513          	addi	a0,a0,542 # 5ab0 <malloc+0x12b8>
    289a:	00002097          	auipc	ra,0x2
    289e:	b58080e7          	jalr	-1192(ra) # 43f2 <unlink>
  fd = open("bd", O_CREATE);
    28a2:	20000593          	li	a1,512
    28a6:	00003517          	auipc	a0,0x3
    28aa:	20a50513          	addi	a0,a0,522 # 5ab0 <malloc+0x12b8>
    28ae:	00002097          	auipc	ra,0x2
    28b2:	b34080e7          	jalr	-1228(ra) # 43e2 <open>
  if(fd < 0){
    28b6:	0c054963          	bltz	a0,2988 <bigdir+0x10c>
  close(fd);
    28ba:	00002097          	auipc	ra,0x2
    28be:	b10080e7          	jalr	-1264(ra) # 43ca <close>
  for(i = 0; i < N; i++){
    28c2:	4901                	li	s2,0
    name[0] = 'x';
    ...
    28cc:	1e8a0a13          	addi	s4,s4,488 # 5ab0 <malloc+0x12b8>
  for(i = 0; i < N; i++){
    ...
    290c:	afa080e7          	jalr	-1286(ra) # 4402 <link>
    2910:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    291e:	19650513          	addi	a0,a0,406 # 5ab0 <malloc+0x12b8>
    2922:	00002097          	auipc	ra,0x2
    2926:	ad0080e7          	jalr	-1328(ra) # 43f2 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    2968:	a8e080e7          	jalr	-1394(ra) # 43f2 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    298e:	12e50513          	addi	a0,a0,302 # 5ab8 <malloc+0x12c0>
    2992:	00002097          	auipc	ra,0x2
    2996:	da8080e7          	jalr	-600(ra) # 473a <printf>
    exit(1);
    299a:	4505                	li	a0,1
    299c:	00002097          	auipc	ra,0x2
    29a0:	a06080e7          	jalr	-1530(ra) # 43a2 <exit>
      printf("%s: bigdir link failed\n", s);
    29a4:	85ce                	mv	a1,s3
    29a6:	00003517          	auipc	a0,0x3
    29aa:	13250513          	addi	a0,a0,306 # 5ad8 <malloc+0x12e0>
    29ae:	00002097          	auipc	ra,0x2
    29b2:	d8c080e7          	jalr	-628(ra) # 473a <printf>
      exit(1);
    29b6:	4505                	li	a0,1
    29b8:	00002097          	auipc	ra,0x2
    29bc:	9ea080e7          	jalr	-1558(ra) # 43a2 <exit>
      printf("%s: bigdir unlink failed", s);
    29c0:	85ce                	mv	a1,s3
    29c2:	00003517          	auipc	a0,0x3
    29c6:	12e50513          	addi	a0,a0,302 # 5af0 <malloc+0x12f8>
    29ca:	00002097          	auipc	ra,0x2
    29ce:	d70080e7          	jalr	-656(ra) # 473a <printf>
      exit(1);
    29d2:	4505                	li	a0,1
    29d4:	00002097          	auipc	ra,0x2
    29d8:	9ce080e7          	jalr	-1586(ra) # 43a2 <exit>
...
00000000000029dc <subdir>:
{
  ...
  unlink("ff");
    ...
    29ee:	25650513          	addi	a0,a0,598 # 5c40 <malloc+0x1448>
    29f2:	00002097          	auipc	ra,0x2
    29f6:	a00080e7          	jalr	-1536(ra) # 43f2 <unlink>
  if(mkdir("dd") != 0){
    29fa:	00003517          	auipc	a0,0x3
    29fe:	11650513          	addi	a0,a0,278 # 5b10 <malloc+0x1318>
    2a02:	00002097          	auipc	ra,0x2
    2a06:	a08080e7          	jalr	-1528(ra) # 440a <mkdir>
    2a0a:	38051663          	bnez	a0,2d96 <subdir+0x3ba>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2a0e:	20200593          	li	a1,514
    2a12:	00003517          	auipc	a0,0x3
    2a16:	11e50513          	addi	a0,a0,286 # 5b30 <malloc+0x1338>
    2a1a:	00002097          	auipc	ra,0x2
    2a1e:	9c8080e7          	jalr	-1592(ra) # 43e2 <open>
    2a22:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2a2e:	21658593          	addi	a1,a1,534 # 5c40 <malloc+0x1448>
    2a32:	00002097          	auipc	ra,0x2
    2a36:	990080e7          	jalr	-1648(ra) # 43c2 <write>
  close(fd);
    2a3a:	8526                	mv	a0,s1
    2a3c:	00002097          	auipc	ra,0x2
    2a40:	98e080e7          	jalr	-1650(ra) # 43ca <close>
  if(unlink("dd") >= 0){
    2a44:	00003517          	auipc	a0,0x3
    2a48:	0cc50513          	addi	a0,a0,204 # 5b10 <malloc+0x1318>
    2a4c:	00002097          	auipc	ra,0x2
    2a50:	9a6080e7          	jalr	-1626(ra) # 43f2 <unlink>
    2a54:	36055d63          	bgez	a0,2dce <subdir+0x3f2>
  if(mkdir("/dd/dd") != 0){
    2a58:	00003517          	auipc	a0,0x3
    2a5c:	13050513          	addi	a0,a0,304 # 5b88 <malloc+0x1390>
    2a60:	00002097          	auipc	ra,0x2
    2a64:	9aa080e7          	jalr	-1622(ra) # 440a <mkdir>
    2a68:	38051163          	bnez	a0,2dea <subdir+0x40e>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2a6c:	20200593          	li	a1,514
    2a70:	00003517          	auipc	a0,0x3
    2a74:	14050513          	addi	a0,a0,320 # 5bb0 <malloc+0x13b8>
    2a78:	00002097          	auipc	ra,0x2
    2a7c:	96a080e7          	jalr	-1686(ra) # 43e2 <open>
    2a80:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2a8c:	15858593          	addi	a1,a1,344 # 5be0 <malloc+0x13e8>
    2a90:	00002097          	auipc	ra,0x2
    2a94:	932080e7          	jalr	-1742(ra) # 43c2 <write>
  close(fd);
    2a98:	8526                	mv	a0,s1
    2a9a:	00002097          	auipc	ra,0x2
    2a9e:	930080e7          	jalr	-1744(ra) # 43ca <close>
  fd = open("dd/dd/../ff", 0);
    2aa2:	4581                	li	a1,0
    2aa4:	00003517          	auipc	a0,0x3
    2aa8:	14450513          	addi	a0,a0,324 # 5be8 <malloc+0x13f0>
    2aac:	00002097          	auipc	ra,0x2
    2ab0:	936080e7          	jalr	-1738(ra) # 43e2 <open>
    2ab4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2ba0:	61c58593          	addi	a1,a1,1564 # 91b8 <buf>
    2ba4:	00002097          	auipc	ra,0x2
    2ba8:	816080e7          	jalr	-2026(ra) # 43ba <read>
    2bac:	4789                	li	a5,2
    2bae:	38f51663          	bne	a0,a5,2f3a <subdir+0x55e>
  close(fd);
    2bb2:	8526                	mv	a0,s1
    2bb4:	00002097          	auipc	ra,0x2
    2bb8:	816080e7          	jalr	-2026(ra) # 43ca <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2bbc:	4581                	li	a1,0
    2bbe:	00003517          	auipc	a0,0x3
    2bc2:	ff250513          	addi	a0,a0,-14 # 5bb0 <malloc+0x13b8>
    2bc6:	00002097          	auipc	ra,0x2
    2bca:	81c080e7          	jalr	-2020(ra) # 43e2 <open>
    2bce:	38055463          	bgez	a0,2f56 <subdir+0x57a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2bd2:	20200593          	li	a1,514
    2bd6:	00003517          	auipc	a0,0x3
    2bda:	1ea50513          	addi	a0,a0,490 # 5dc0 <malloc+0x15c8>
    2bde:	00002097          	auipc	ra,0x2
    2be2:	804080e7          	jalr	-2044(ra) # 43e2 <open>
    2be6:	38055663          	bgez	a0,2f72 <subdir+0x596>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2bea:	20200593          	li	a1,514
    2bee:	00003517          	auipc	a0,0x3
    2bf2:	20250513          	addi	a0,a0,514 # 5df0 <malloc+0x15f8>
    2bf6:	00001097          	auipc	ra,0x1
    2bfa:	7ec080e7          	jalr	2028(ra) # 43e2 <open>
    2bfe:	38055863          	bgez	a0,2f8e <subdir+0x5b2>
  if(open("dd", O_CREATE) >= 0){
    2c02:	20000593          	li	a1,512
    2c06:	00003517          	auipc	a0,0x3
    2c0a:	f0a50513          	addi	a0,a0,-246 # 5b10 <malloc+0x1318>
    2c0e:	00001097          	auipc	ra,0x1
    2c12:	7d4080e7          	jalr	2004(ra) # 43e2 <open>
    2c16:	38055a63          	bgez	a0,2faa <subdir+0x5ce>
  if(open("dd", O_RDWR) >= 0){
    2c1a:	4589                	li	a1,2
    2c1c:	00003517          	auipc	a0,0x3
    2c20:	ef450513          	addi	a0,a0,-268 # 5b10 <malloc+0x1318>
    2c24:	00001097          	auipc	ra,0x1
    2c28:	7be080e7          	jalr	1982(ra) # 43e2 <open>
    2c2c:	38055d63          	bgez	a0,2fc6 <subdir+0x5ea>
  if(open("dd", O_WRONLY) >= 0){
    2c30:	4585                	li	a1,1
    2c32:	00003517          	auipc	a0,0x3
    2c36:	ede50513          	addi	a0,a0,-290 # 5b10 <malloc+0x1318>
    2c3a:	00001097          	auipc	ra,0x1
    2c3e:	7a8080e7          	jalr	1960(ra) # 43e2 <open>
    2c42:	3a055063          	bgez	a0,2fe2 <subdir+0x606>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2c46:	00003597          	auipc	a1,0x3
    2c4a:	23a58593          	addi	a1,a1,570 # 5e80 <malloc+0x1688>
    2c4e:	00003517          	auipc	a0,0x3
    2c52:	17250513          	addi	a0,a0,370 # 5dc0 <malloc+0x15c8>
    2c56:	00001097          	auipc	ra,0x1
    2c5a:	7ac080e7          	jalr	1964(ra) # 4402 <link>
    2c5e:	3a050063          	beqz	a0,2ffe <subdir+0x622>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2c62:	00003597          	auipc	a1,0x3
    2c66:	21e58593          	addi	a1,a1,542 # 5e80 <malloc+0x1688>
    2c6a:	00003517          	auipc	a0,0x3
    2c6e:	18650513          	addi	a0,a0,390 # 5df0 <malloc+0x15f8>
    2c72:	00001097          	auipc	ra,0x1
    2c76:	790080e7          	jalr	1936(ra) # 4402 <link>
    2c7a:	3a050063          	beqz	a0,301a <subdir+0x63e>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2c7e:	00003597          	auipc	a1,0x3
    2c82:	fba58593          	addi	a1,a1,-70 # 5c38 <malloc+0x1440>
    2c86:	00003517          	auipc	a0,0x3
    2c8a:	eaa50513          	addi	a0,a0,-342 # 5b30 <malloc+0x1338>
    2c8e:	00001097          	auipc	ra,0x1
    2c92:	774080e7          	jalr	1908(ra) # 4402 <link>
    2c96:	3a050063          	beqz	a0,3036 <subdir+0x65a>
  if(mkdir("dd/ff/ff") == 0){
    2c9a:	00003517          	auipc	a0,0x3
    2c9e:	12650513          	addi	a0,a0,294 # 5dc0 <malloc+0x15c8>
    2ca2:	00001097          	auipc	ra,0x1
    2ca6:	768080e7          	jalr	1896(ra) # 440a <mkdir>
    2caa:	3a050463          	beqz	a0,3052 <subdir+0x676>
  if(mkdir("dd/xx/ff") == 0){
    2cae:	00003517          	auipc	a0,0x3
    2cb2:	14250513          	addi	a0,a0,322 # 5df0 <malloc+0x15f8>
    2cb6:	00001097          	auipc	ra,0x1
    2cba:	754080e7          	jalr	1876(ra) # 440a <mkdir>
    2cbe:	3a050863          	beqz	a0,306e <subdir+0x692>
  if(mkdir("dd/dd/ffff") == 0){
    2cc2:	00003517          	auipc	a0,0x3
    2cc6:	f7650513          	addi	a0,a0,-138 # 5c38 <malloc+0x1440>
    2cca:	00001097          	auipc	ra,0x1
    2cce:	740080e7          	jalr	1856(ra) # 440a <mkdir>
    2cd2:	3a050c63          	beqz	a0,308a <subdir+0x6ae>
  if(unlink("dd/xx/ff") == 0){
    2cd6:	00003517          	auipc	a0,0x3
    2cda:	11a50513          	addi	a0,a0,282 # 5df0 <malloc+0x15f8>
    2cde:	00001097          	auipc	ra,0x1
    2ce2:	714080e7          	jalr	1812(ra) # 43f2 <unlink>
    2ce6:	3c050063          	beqz	a0,30a6 <subdir+0x6ca>
  if(unlink("dd/ff/ff") == 0){
    2cea:	00003517          	auipc	a0,0x3
    2cee:	0d650513          	addi	a0,a0,214 # 5dc0 <malloc+0x15c8>
    2cf2:	00001097          	auipc	ra,0x1
    2cf6:	700080e7          	jalr	1792(ra) # 43f2 <unlink>
    2cfa:	3c050463          	beqz	a0,30c2 <subdir+0x6e6>
  if(chdir("dd/ff") == 0){
    2cfe:	00003517          	auipc	a0,0x3
    2d02:	e3250513          	addi	a0,a0,-462 # 5b30 <malloc+0x1338>
    2d06:	00001097          	auipc	ra,0x1
    2d0a:	70c080e7          	jalr	1804(ra) # 4412 <chdir>
    2d0e:	3c050863          	beqz	a0,30de <subdir+0x702>
  if(chdir("dd/xx") == 0){
    2d12:	00003517          	auipc	a0,0x3
    2d16:	2be50513          	addi	a0,a0,702 # 5fd0 <malloc+0x17d8>
    2d1a:	00001097          	auipc	ra,0x1
    2d1e:	6f8080e7          	jalr	1784(ra) # 4412 <chdir>
    2d22:	3c050c63          	beqz	a0,30fa <subdir+0x71e>
  if(unlink("dd/dd/ffff") != 0){
    2d26:	00003517          	auipc	a0,0x3
    2d2a:	f1250513          	addi	a0,a0,-238 # 5c38 <malloc+0x1440>
    2d2e:	00001097          	auipc	ra,0x1
    2d32:	6c4080e7          	jalr	1732(ra) # 43f2 <unlink>
    2d36:	3e051063          	bnez	a0,3116 <subdir+0x73a>
  if(unlink("dd/ff") != 0){
    2d3a:	00003517          	auipc	a0,0x3
    2d3e:	df650513          	addi	a0,a0,-522 # 5b30 <malloc+0x1338>
    2d42:	00001097          	auipc	ra,0x1
    2d46:	6b0080e7          	jalr	1712(ra) # 43f2 <unlink>
    2d4a:	3e051463          	bnez	a0,3132 <subdir+0x756>
  if(unlink("dd") == 0){
    2d4e:	00003517          	auipc	a0,0x3
    2d52:	dc250513          	addi	a0,a0,-574 # 5b10 <malloc+0x1318>
    2d56:	00001097          	auipc	ra,0x1
    2d5a:	69c080e7          	jalr	1692(ra) # 43f2 <unlink>
    2d5e:	3e050863          	beqz	a0,314e <subdir+0x772>
  if(unlink("dd/dd") < 0){
    2d62:	00003517          	auipc	a0,0x3
    2d66:	2de50513          	addi	a0,a0,734 # 6040 <malloc+0x1848>
    2d6a:	00001097          	auipc	ra,0x1
    2d6e:	688080e7          	jalr	1672(ra) # 43f2 <unlink>
    2d72:	3e054c63          	bltz	a0,316a <subdir+0x78e>
  if(unlink("dd") < 0){
    2d76:	00003517          	auipc	a0,0x3
    2d7a:	d9a50513          	addi	a0,a0,-614 # 5b10 <malloc+0x1318>
    2d7e:	00001097          	auipc	ra,0x1
    2d82:	674080e7          	jalr	1652(ra) # 43f2 <unlink>
    ...
    2d9c:	d8050513          	addi	a0,a0,-640 # 5b18 <malloc+0x1320>
    2da0:	00002097          	auipc	ra,0x2
    2da4:	99a080e7          	jalr	-1638(ra) # 473a <printf>
    exit(1);
    2da8:	4505                	li	a0,1
    2daa:	00001097          	auipc	ra,0x1
    2dae:	5f8080e7          	jalr	1528(ra) # 43a2 <exit>
    printf("%s: create dd/ff failed\n", s);
    2db2:	85ca                	mv	a1,s2
    2db4:	00003517          	auipc	a0,0x3
    2db8:	d8450513          	addi	a0,a0,-636 # 5b38 <malloc+0x1340>
    2dbc:	00002097          	auipc	ra,0x2
    2dc0:	97e080e7          	jalr	-1666(ra) # 473a <printf>
    exit(1);
    2dc4:	4505                	li	a0,1
    2dc6:	00001097          	auipc	ra,0x1
    2dca:	5dc080e7          	jalr	1500(ra) # 43a2 <exit>
    printf("%s: unlink dd (non-empty dir) succeeded!\n", s);
    2dce:	85ca                	mv	a1,s2
    2dd0:	00003517          	auipc	a0,0x3
    2dd4:	d8850513          	addi	a0,a0,-632 # 5b58 <malloc+0x1360>
    2dd8:	00002097          	auipc	ra,0x2
    2ddc:	962080e7          	jalr	-1694(ra) # 473a <printf>
    exit(1);
    2de0:	4505                	li	a0,1
    2de2:	00001097          	auipc	ra,0x1
    2de6:	5c0080e7          	jalr	1472(ra) # 43a2 <exit>
    printf("subdir mkdir dd/dd failed\n", s);
    2dea:	85ca                	mv	a1,s2
    2dec:	00003517          	auipc	a0,0x3
    2df0:	da450513          	addi	a0,a0,-604 # 5b90 <malloc+0x1398>
    2df4:	00002097          	auipc	ra,0x2
    2df8:	946080e7          	jalr	-1722(ra) # 473a <printf>
    exit(1);
    2dfc:	4505                	li	a0,1
    2dfe:	00001097          	auipc	ra,0x1
    2e02:	5a4080e7          	jalr	1444(ra) # 43a2 <exit>
    printf("%s: create dd/dd/ff failed\n", s);
    2e06:	85ca                	mv	a1,s2
    2e08:	00003517          	auipc	a0,0x3
    2e0c:	db850513          	addi	a0,a0,-584 # 5bc0 <malloc+0x13c8>
    2e10:	00002097          	auipc	ra,0x2
    2e14:	92a080e7          	jalr	-1750(ra) # 473a <printf>
    exit(1);
    2e18:	4505                	li	a0,1
    2e1a:	00001097          	auipc	ra,0x1
    2e1e:	588080e7          	jalr	1416(ra) # 43a2 <exit>
    printf("%s: open dd/dd/../ff failed\n", s);
    2e22:	85ca                	mv	a1,s2
    2e24:	00003517          	auipc	a0,0x3
    2e28:	dd450513          	addi	a0,a0,-556 # 5bf8 <malloc+0x1400>
    2e2c:	00002097          	auipc	ra,0x2
    2e30:	90e080e7          	jalr	-1778(ra) # 473a <printf>
    exit(1);
    2e34:	4505                	li	a0,1
    2e36:	00001097          	auipc	ra,0x1
    2e3a:	56c080e7          	jalr	1388(ra) # 43a2 <exit>
    printf("%s: dd/dd/../ff wrong content\n", s);
    2e3e:	85ca                	mv	a1,s2
    2e40:	00003517          	auipc	a0,0x3
    2e44:	dd850513          	addi	a0,a0,-552 # 5c18 <malloc+0x1420>
    2e48:	00002097          	auipc	ra,0x2
    2e4c:	8f2080e7          	jalr	-1806(ra) # 473a <printf>
    exit(1);
    2e50:	4505                	li	a0,1
    2e52:	00001097          	auipc	ra,0x1
    2e56:	550080e7          	jalr	1360(ra) # 43a2 <exit>
    printf("link dd/dd/ff dd/dd/ffff failed\n", s);
    2e5a:	85ca                	mv	a1,s2
    2e5c:	00003517          	auipc	a0,0x3
    2e60:	dec50513          	addi	a0,a0,-532 # 5c48 <malloc+0x1450>
    2e64:	00002097          	auipc	ra,0x2
    2e68:	8d6080e7          	jalr	-1834(ra) # 473a <printf>
    exit(1);
    2e6c:	4505                	li	a0,1
    2e6e:	00001097          	auipc	ra,0x1
    2e72:	534080e7          	jalr	1332(ra) # 43a2 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    2e76:	85ca                	mv	a1,s2
    2e78:	00003517          	auipc	a0,0x3
    2e7c:	df850513          	addi	a0,a0,-520 # 5c70 <malloc+0x1478>
    2e80:	00002097          	auipc	ra,0x2
    2e84:	8ba080e7          	jalr	-1862(ra) # 473a <printf>
    exit(1);
    2e88:	4505                	li	a0,1
    2e8a:	00001097          	auipc	ra,0x1
    2e8e:	518080e7          	jalr	1304(ra) # 43a2 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded\n", s);
    2e92:	85ca                	mv	a1,s2
    2e94:	00003517          	auipc	a0,0x3
    2e98:	dfc50513          	addi	a0,a0,-516 # 5c90 <malloc+0x1498>
    2e9c:	00002097          	auipc	ra,0x2
    2ea0:	89e080e7          	jalr	-1890(ra) # 473a <printf>
    exit(1);
    2ea4:	4505                	li	a0,1
    2ea6:	00001097          	auipc	ra,0x1
    2eaa:	4fc080e7          	jalr	1276(ra) # 43a2 <exit>
    printf("%s: chdir dd failed\n", s);
    2eae:	85ca                	mv	a1,s2
    2eb0:	00003517          	auipc	a0,0x3
    2eb4:	e0850513          	addi	a0,a0,-504 # 5cb8 <malloc+0x14c0>
    2eb8:	00002097          	auipc	ra,0x2
    2ebc:	882080e7          	jalr	-1918(ra) # 473a <printf>
    exit(1);
    2ec0:	4505                	li	a0,1
    2ec2:	00001097          	auipc	ra,0x1
    2ec6:	4e0080e7          	jalr	1248(ra) # 43a2 <exit>
    printf("%s: chdir dd/../../dd failed\n", s);
    2eca:	85ca                	mv	a1,s2
    2ecc:	00003517          	auipc	a0,0x3
    2ed0:	e1450513          	addi	a0,a0,-492 # 5ce0 <malloc+0x14e8>
    2ed4:	00002097          	auipc	ra,0x2
    2ed8:	866080e7          	jalr	-1946(ra) # 473a <printf>
    exit(1);
    2edc:	4505                	li	a0,1
    2ede:	00001097          	auipc	ra,0x1
    2ee2:	4c4080e7          	jalr	1220(ra) # 43a2 <exit>
    printf("chdir dd/../../dd failed\n", s);
    2ee6:	85ca                	mv	a1,s2
    2ee8:	00003517          	auipc	a0,0x3
    2eec:	e2850513          	addi	a0,a0,-472 # 5d10 <malloc+0x1518>
    2ef0:	00002097          	auipc	ra,0x2
    2ef4:	84a080e7          	jalr	-1974(ra) # 473a <printf>
    exit(1);
    2ef8:	4505                	li	a0,1
    2efa:	00001097          	auipc	ra,0x1
    2efe:	4a8080e7          	jalr	1192(ra) # 43a2 <exit>
    printf("%s: chdir ./.. failed\n", s);
    2f02:	85ca                	mv	a1,s2
    2f04:	00003517          	auipc	a0,0x3
    2f08:	e3450513          	addi	a0,a0,-460 # 5d38 <malloc+0x1540>
    2f0c:	00002097          	auipc	ra,0x2
    2f10:	82e080e7          	jalr	-2002(ra) # 473a <printf>
    exit(1);
    2f14:	4505                	li	a0,1
    2f16:	00001097          	auipc	ra,0x1
    2f1a:	48c080e7          	jalr	1164(ra) # 43a2 <exit>
    printf("%s: open dd/dd/ffff failed\n", s);
    2f1e:	85ca                	mv	a1,s2
    2f20:	00003517          	auipc	a0,0x3
    2f24:	e3050513          	addi	a0,a0,-464 # 5d50 <malloc+0x1558>
    2f28:	00002097          	auipc	ra,0x2
    2f2c:	812080e7          	jalr	-2030(ra) # 473a <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    2f32:	00001097          	auipc	ra,0x1
    2f36:	470080e7          	jalr	1136(ra) # 43a2 <exit>
    printf("%s: read dd/dd/ffff wrong len\n", s);
    2f3a:	85ca                	mv	a1,s2
    2f3c:	00003517          	auipc	a0,0x3
    2f40:	e3450513          	addi	a0,a0,-460 # 5d70 <malloc+0x1578>
    2f44:	00001097          	auipc	ra,0x1
    2f48:	7f6080e7          	jalr	2038(ra) # 473a <printf>
    exit(1);
    2f4c:	4505                	li	a0,1
    2f4e:	00001097          	auipc	ra,0x1
    2f52:	454080e7          	jalr	1108(ra) # 43a2 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    2f56:	85ca                	mv	a1,s2
    2f58:	00003517          	auipc	a0,0x3
    2f5c:	e3850513          	addi	a0,a0,-456 # 5d90 <malloc+0x1598>
    2f60:	00001097          	auipc	ra,0x1
    2f64:	7da080e7          	jalr	2010(ra) # 473a <printf>
    exit(1);
    2f68:	4505                	li	a0,1
    2f6a:	00001097          	auipc	ra,0x1
    2f6e:	438080e7          	jalr	1080(ra) # 43a2 <exit>
    printf("%s: create dd/ff/ff succeeded!\n", s);
    2f72:	85ca                	mv	a1,s2
    2f74:	00003517          	auipc	a0,0x3
    2f78:	e5c50513          	addi	a0,a0,-420 # 5dd0 <malloc+0x15d8>
    2f7c:	00001097          	auipc	ra,0x1
    2f80:	7be080e7          	jalr	1982(ra) # 473a <printf>
    exit(1);
    2f84:	4505                	li	a0,1
    2f86:	00001097          	auipc	ra,0x1
    2f8a:	41c080e7          	jalr	1052(ra) # 43a2 <exit>
    printf("%s: create dd/xx/ff succeeded!\n", s);
    2f8e:	85ca                	mv	a1,s2
    2f90:	00003517          	auipc	a0,0x3
    2f94:	e7050513          	addi	a0,a0,-400 # 5e00 <malloc+0x1608>
    2f98:	00001097          	auipc	ra,0x1
    2f9c:	7a2080e7          	jalr	1954(ra) # 473a <printf>
    exit(1);
    2fa0:	4505                	li	a0,1
    2fa2:	00001097          	auipc	ra,0x1
    2fa6:	400080e7          	jalr	1024(ra) # 43a2 <exit>
    printf("%s: create dd succeeded!\n", s);
    2faa:	85ca                	mv	a1,s2
    2fac:	00003517          	auipc	a0,0x3
    2fb0:	e7450513          	addi	a0,a0,-396 # 5e20 <malloc+0x1628>
    2fb4:	00001097          	auipc	ra,0x1
    2fb8:	786080e7          	jalr	1926(ra) # 473a <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    2fbe:	00001097          	auipc	ra,0x1
    2fc2:	3e4080e7          	jalr	996(ra) # 43a2 <exit>
    printf("%s: open dd rdwr succeeded!\n", s);
    2fc6:	85ca                	mv	a1,s2
    2fc8:	00003517          	auipc	a0,0x3
    2fcc:	e7850513          	addi	a0,a0,-392 # 5e40 <malloc+0x1648>
    2fd0:	00001097          	auipc	ra,0x1
    2fd4:	76a080e7          	jalr	1898(ra) # 473a <printf>
    exit(1);
    2fd8:	4505                	li	a0,1
    2fda:	00001097          	auipc	ra,0x1
    2fde:	3c8080e7          	jalr	968(ra) # 43a2 <exit>
    printf("%s: open dd wronly succeeded!\n", s);
    2fe2:	85ca                	mv	a1,s2
    2fe4:	00003517          	auipc	a0,0x3
    2fe8:	e7c50513          	addi	a0,a0,-388 # 5e60 <malloc+0x1668>
    2fec:	00001097          	auipc	ra,0x1
    2ff0:	74e080e7          	jalr	1870(ra) # 473a <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    2ff6:	00001097          	auipc	ra,0x1
    2ffa:	3ac080e7          	jalr	940(ra) # 43a2 <exit>
    printf("%s: link dd/ff/ff dd/dd/xx succeeded!\n", s);
    2ffe:	85ca                	mv	a1,s2
    3000:	00003517          	auipc	a0,0x3
    3004:	e9050513          	addi	a0,a0,-368 # 5e90 <malloc+0x1698>
    3008:	00001097          	auipc	ra,0x1
    300c:	732080e7          	jalr	1842(ra) # 473a <printf>
    exit(1);
    3010:	4505                	li	a0,1
    3012:	00001097          	auipc	ra,0x1
    3016:	390080e7          	jalr	912(ra) # 43a2 <exit>
    printf("%s: link dd/xx/ff dd/dd/xx succeeded!\n", s);
    301a:	85ca                	mv	a1,s2
    301c:	00003517          	auipc	a0,0x3
    3020:	e9c50513          	addi	a0,a0,-356 # 5eb8 <malloc+0x16c0>
    3024:	00001097          	auipc	ra,0x1
    3028:	716080e7          	jalr	1814(ra) # 473a <printf>
    exit(1);
    302c:	4505                	li	a0,1
    302e:	00001097          	auipc	ra,0x1
    3032:	374080e7          	jalr	884(ra) # 43a2 <exit>
    printf("%s: link dd/ff dd/dd/ffff succeeded!\n", s);
    3036:	85ca                	mv	a1,s2
    3038:	00003517          	auipc	a0,0x3
    303c:	ea850513          	addi	a0,a0,-344 # 5ee0 <malloc+0x16e8>
    3040:	00001097          	auipc	ra,0x1
    3044:	6fa080e7          	jalr	1786(ra) # 473a <printf>
    exit(1);
    3048:	4505                	li	a0,1
    304a:	00001097          	auipc	ra,0x1
    304e:	358080e7          	jalr	856(ra) # 43a2 <exit>
    printf("%s: mkdir dd/ff/ff succeeded!\n", s);
    3052:	85ca                	mv	a1,s2
    3054:	00003517          	auipc	a0,0x3
    3058:	eb450513          	addi	a0,a0,-332 # 5f08 <malloc+0x1710>
    305c:	00001097          	auipc	ra,0x1
    3060:	6de080e7          	jalr	1758(ra) # 473a <printf>
    exit(1);
    3064:	4505                	li	a0,1
    3066:	00001097          	auipc	ra,0x1
    306a:	33c080e7          	jalr	828(ra) # 43a2 <exit>
    printf("%s: mkdir dd/xx/ff succeeded!\n", s);
    306e:	85ca                	mv	a1,s2
    3070:	00003517          	auipc	a0,0x3
    3074:	eb850513          	addi	a0,a0,-328 # 5f28 <malloc+0x1730>
    3078:	00001097          	auipc	ra,0x1
    307c:	6c2080e7          	jalr	1730(ra) # 473a <printf>
    exit(1);
    3080:	4505                	li	a0,1
    3082:	00001097          	auipc	ra,0x1
    3086:	320080e7          	jalr	800(ra) # 43a2 <exit>
    printf("%s: mkdir dd/dd/ffff succeeded!\n", s);
    308a:	85ca                	mv	a1,s2
    308c:	00003517          	auipc	a0,0x3
    3090:	ebc50513          	addi	a0,a0,-324 # 5f48 <malloc+0x1750>
    3094:	00001097          	auipc	ra,0x1
    3098:	6a6080e7          	jalr	1702(ra) # 473a <printf>
    exit(1);
    309c:	4505                	li	a0,1
    309e:	00001097          	auipc	ra,0x1
    30a2:	304080e7          	jalr	772(ra) # 43a2 <exit>
    printf("%s: unlink dd/xx/ff succeeded!\n", s);
    30a6:	85ca                	mv	a1,s2
    30a8:	00003517          	auipc	a0,0x3
    30ac:	ec850513          	addi	a0,a0,-312 # 5f70 <malloc+0x1778>
    30b0:	00001097          	auipc	ra,0x1
    30b4:	68a080e7          	jalr	1674(ra) # 473a <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    30ba:	00001097          	auipc	ra,0x1
    30be:	2e8080e7          	jalr	744(ra) # 43a2 <exit>
    printf("%s: unlink dd/ff/ff succeeded!\n", s);
    30c2:	85ca                	mv	a1,s2
    30c4:	00003517          	auipc	a0,0x3
    30c8:	ecc50513          	addi	a0,a0,-308 # 5f90 <malloc+0x1798>
    30cc:	00001097          	auipc	ra,0x1
    30d0:	66e080e7          	jalr	1646(ra) # 473a <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    30d6:	00001097          	auipc	ra,0x1
    30da:	2cc080e7          	jalr	716(ra) # 43a2 <exit>
    printf("%s: chdir dd/ff succeeded!\n", s);
    30de:	85ca                	mv	a1,s2
    30e0:	00003517          	auipc	a0,0x3
    30e4:	ed050513          	addi	a0,a0,-304 # 5fb0 <malloc+0x17b8>
    30e8:	00001097          	auipc	ra,0x1
    30ec:	652080e7          	jalr	1618(ra) # 473a <printf>
    exit(1);
    30f0:	4505                	li	a0,1
    30f2:	00001097          	auipc	ra,0x1
    30f6:	2b0080e7          	jalr	688(ra) # 43a2 <exit>
    printf("%s: chdir dd/xx succeeded!\n", s);
    30fa:	85ca                	mv	a1,s2
    30fc:	00003517          	auipc	a0,0x3
    3100:	edc50513          	addi	a0,a0,-292 # 5fd8 <malloc+0x17e0>
    3104:	00001097          	auipc	ra,0x1
    3108:	636080e7          	jalr	1590(ra) # 473a <printf>
    exit(1);
    310c:	4505                	li	a0,1
    310e:	00001097          	auipc	ra,0x1
    3112:	294080e7          	jalr	660(ra) # 43a2 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3116:	85ca                	mv	a1,s2
    3118:	00003517          	auipc	a0,0x3
    311c:	b5850513          	addi	a0,a0,-1192 # 5c70 <malloc+0x1478>
    3120:	00001097          	auipc	ra,0x1
    3124:	61a080e7          	jalr	1562(ra) # 473a <printf>
    exit(1);
    3128:	4505                	li	a0,1
    312a:	00001097          	auipc	ra,0x1
    312e:	278080e7          	jalr	632(ra) # 43a2 <exit>
    printf("%s: unlink dd/ff failed\n", s);
    3132:	85ca                	mv	a1,s2
    3134:	00003517          	auipc	a0,0x3
    3138:	ec450513          	addi	a0,a0,-316 # 5ff8 <malloc+0x1800>
    313c:	00001097          	auipc	ra,0x1
    3140:	5fe080e7          	jalr	1534(ra) # 473a <printf>
    exit(1);
    3144:	4505                	li	a0,1
    3146:	00001097          	auipc	ra,0x1
    314a:	25c080e7          	jalr	604(ra) # 43a2 <exit>
    printf("%s: unlink non-empty dd succeeded!\n", s);
    314e:	85ca                	mv	a1,s2
    3150:	00003517          	auipc	a0,0x3
    3154:	ec850513          	addi	a0,a0,-312 # 6018 <malloc+0x1820>
    3158:	00001097          	auipc	ra,0x1
    315c:	5e2080e7          	jalr	1506(ra) # 473a <printf>
    exit(1);
    3160:	4505                	li	a0,1
    3162:	00001097          	auipc	ra,0x1
    3166:	240080e7          	jalr	576(ra) # 43a2 <exit>
    printf("%s: unlink dd/dd failed\n", s);
    316a:	85ca                	mv	a1,s2
    316c:	00003517          	auipc	a0,0x3
    3170:	edc50513          	addi	a0,a0,-292 # 6048 <malloc+0x1850>
    3174:	00001097          	auipc	ra,0x1
    3178:	5c6080e7          	jalr	1478(ra) # 473a <printf>
    exit(1);
    317c:	4505                	li	a0,1
    317e:	00001097          	auipc	ra,0x1
    3182:	224080e7          	jalr	548(ra) # 43a2 <exit>
    printf("%s: unlink dd failed\n", s);
    3186:	85ca                	mv	a1,s2
    3188:	00003517          	auipc	a0,0x3
    318c:	ee050513          	addi	a0,a0,-288 # 6068 <malloc+0x1870>
    3190:	00001097          	auipc	ra,0x1
    3194:	5aa080e7          	jalr	1450(ra) # 473a <printf>
    exit(1);
    3198:	4505                	li	a0,1
    319a:	00001097          	auipc	ra,0x1
    319e:	208080e7          	jalr	520(ra) # 43a2 <exit>
...
00000000000031a2 <dirfile>:
{
  ...
  close(fd);
    ...
    32c4:	dc050513          	addi	a0,a0,-576 # 6080 <malloc+0x1888>
    32c8:	00001097          	auipc	ra,0x1
    32cc:	472080e7          	jalr	1138(ra) # 473a <printf>
    exit(1);
    32d0:	4505                	li	a0,1
    32d2:	00001097          	auipc	ra,0x1
    32d6:	0d0080e7          	jalr	208(ra) # 43a2 <exit>
    printf("%s: chdir dirfile succeeded!\n", s);
    32da:	85ca                	mv	a1,s2
    32dc:	00003517          	auipc	a0,0x3
    32e0:	dc450513          	addi	a0,a0,-572 # 60a0 <malloc+0x18a8>
    32e4:	00001097          	auipc	ra,0x1
    32e8:	456080e7          	jalr	1110(ra) # 473a <printf>
    exit(1);
    32ec:	4505                	li	a0,1
    32ee:	00001097          	auipc	ra,0x1
    32f2:	0b4080e7          	jalr	180(ra) # 43a2 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    32f6:	85ca                	mv	a1,s2
    32f8:	00003517          	auipc	a0,0x3
    32fc:	dd850513          	addi	a0,a0,-552 # 60d0 <malloc+0x18d8>
    3300:	00001097          	auipc	ra,0x1
    3304:	43a080e7          	jalr	1082(ra) # 473a <printf>
    exit(1);
    3308:	4505                	li	a0,1
    330a:	00001097          	auipc	ra,0x1
    330e:	098080e7          	jalr	152(ra) # 43a2 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3312:	85ca                	mv	a1,s2
    3314:	00003517          	auipc	a0,0x3
    3318:	dbc50513          	addi	a0,a0,-580 # 60d0 <malloc+0x18d8>
    331c:	00001097          	auipc	ra,0x1
    3320:	41e080e7          	jalr	1054(ra) # 473a <printf>
    exit(1);
    3324:	4505                	li	a0,1
    3326:	00001097          	auipc	ra,0x1
    332a:	07c080e7          	jalr	124(ra) # 43a2 <exit>
    printf("%s: mkdir dirfile/xx succeeded!\n", s);
    332e:	85ca                	mv	a1,s2
    3330:	00003517          	auipc	a0,0x3
    3334:	dc850513          	addi	a0,a0,-568 # 60f8 <malloc+0x1900>
    3338:	00001097          	auipc	ra,0x1
    333c:	402080e7          	jalr	1026(ra) # 473a <printf>
    exit(1);
    3340:	4505                	li	a0,1
    3342:	00001097          	auipc	ra,0x1
    3346:	060080e7          	jalr	96(ra) # 43a2 <exit>
    printf("%s: unlink dirfile/xx succeeded!\n", s);
    334a:	85ca                	mv	a1,s2
    334c:	00003517          	auipc	a0,0x3
    3350:	dd450513          	addi	a0,a0,-556 # 6120 <malloc+0x1928>
    3354:	00001097          	auipc	ra,0x1
    3358:	3e6080e7          	jalr	998(ra) # 473a <printf>
    exit(1);
    335c:	4505                	li	a0,1
    335e:	00001097          	auipc	ra,0x1
    3362:	044080e7          	jalr	68(ra) # 43a2 <exit>
    printf("%s: link to dirfile/xx succeeded!\n", s);
    3366:	85ca                	mv	a1,s2
    3368:	00003517          	auipc	a0,0x3
    336c:	de850513          	addi	a0,a0,-536 # 6150 <malloc+0x1958>
    3370:	00001097          	auipc	ra,0x1
    3374:	3ca080e7          	jalr	970(ra) # 473a <printf>
    exit(1);
    3378:	4505                	li	a0,1
    337a:	00001097          	auipc	ra,0x1
    337e:	028080e7          	jalr	40(ra) # 43a2 <exit>
    printf("%s: unlink dirfile failed!\n", s);
    3382:	85ca                	mv	a1,s2
    3384:	00003517          	auipc	a0,0x3
    3388:	df450513          	addi	a0,a0,-524 # 6178 <malloc+0x1980>
    338c:	00001097          	auipc	ra,0x1
    3390:	3ae080e7          	jalr	942(ra) # 473a <printf>
    exit(1);
    3394:	4505                	li	a0,1
    3396:	00001097          	auipc	ra,0x1
    339a:	00c080e7          	jalr	12(ra) # 43a2 <exit>
    printf("%s: open . for writing succeeded!\n", s);
    339e:	85ca                	mv	a1,s2
    33a0:	00003517          	auipc	a0,0x3
    33a4:	df850513          	addi	a0,a0,-520 # 6198 <malloc+0x19a0>
    33a8:	00001097          	auipc	ra,0x1
    33ac:	392080e7          	jalr	914(ra) # 473a <printf>
    exit(1);
    33b0:	4505                	li	a0,1
    33b2:	00001097          	auipc	ra,0x1
    33b6:	ff0080e7          	jalr	-16(ra) # 43a2 <exit>
    printf("%s: write . succeeded!\n", s);
    33ba:	85ca                	mv	a1,s2
    33bc:	00003517          	auipc	a0,0x3
    33c0:	e0450513          	addi	a0,a0,-508 # 61c0 <malloc+0x19c8>
    33c4:	00001097          	auipc	ra,0x1
    33c8:	376080e7          	jalr	886(ra) # 473a <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    33ce:	00001097          	auipc	ra,0x1
    33d2:	fd4080e7          	jalr	-44(ra) # 43a2 <exit>
...
00000000000033d6 <iref>:
{
    ...
    33f4:	de8a0a13          	addi	s4,s4,-536 # 61d8 <malloc+0x19e0>
    mkdir("");
    33f8:	00003497          	auipc	s1,0x3
    33fc:	9c048493          	addi	s1,s1,-1600 # 5db8 <malloc+0x15c0>
    link("README", "");
    3400:	00003a97          	auipc	s5,0x3
    3404:	d48a8a93          	addi	s5,s5,-696 # 6148 <malloc+0x1950>
    fd = open("xx", O_CREATE);
    3408:	00003997          	auipc	s3,0x3
    340c:	cc098993          	addi	s3,s3,-832 # 60c8 <malloc+0x18d0>
    3410:	a891                	j	3464 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3412:	85da                	mv	a1,s6
    3414:	00003517          	auipc	a0,0x3
    3418:	dcc50513          	addi	a0,a0,-564 # 61e0 <malloc+0x19e8>
    341c:	00001097          	auipc	ra,0x1
    3420:	31e080e7          	jalr	798(ra) # 473a <printf>
      exit(1);
    3424:	4505                	li	a0,1
    3426:	00001097          	auipc	ra,0x1
    342a:	f7c080e7          	jalr	-132(ra) # 43a2 <exit>
      printf("%s: chdir irefd failed\n", s);
    342e:	85da                	mv	a1,s6
    3430:	00003517          	auipc	a0,0x3
    3434:	dc850513          	addi	a0,a0,-568 # 61f8 <malloc+0x1a00>
    3438:	00001097          	auipc	ra,0x1
    343c:	302080e7          	jalr	770(ra) # 473a <printf>
      exit(1);
    3440:	4505                	li	a0,1
    3442:	00001097          	auipc	ra,0x1
    3446:	f60080e7          	jalr	-160(ra) # 43a2 <exit>
      close(fd);
    344a:	00001097          	auipc	ra,0x1
    344e:	f80080e7          	jalr	-128(ra) # 43ca <close>
    3452:	a889                	j	34a4 <iref+0xce>
    unlink("xx");
    3454:	854e                	mv	a0,s3
    3456:	00001097          	auipc	ra,0x1
    345a:	f9c080e7          	jalr	-100(ra) # 43f2 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    34ae:	f38080e7          	jalr	-200(ra) # 43e2 <open>
    if(fd >= 0)
    34b2:	fa0541e3          	bltz	a0,3454 <iref+0x7e>
      close(fd);
    34b6:	00001097          	auipc	ra,0x1
    34ba:	f14080e7          	jalr	-236(ra) # 43ca <close>
    34be:	bf59                	j	3454 <iref+0x7e>
  chdir("/");
    34c0:	00001517          	auipc	a0,0x1
    34c4:	73050513          	addi	a0,a0,1840 # 4bf0 <malloc+0x3f8>
    34c8:	00001097          	auipc	ra,0x1
    34cc:	f4a080e7          	jalr	-182(ra) # 4412 <chdir>
}
...
00000000000034e4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    3500:	d1498993          	addi	s3,s3,-748 # 6210 <malloc+0x1a18>
    3504:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    3514:	ef2080e7          	jalr	-270(ra) # 4402 <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    353c:	ce850513          	addi	a0,a0,-792 # 6220 <malloc+0x1a28>
    3540:	00001097          	auipc	ra,0x1
    3544:	1fa080e7          	jalr	506(ra) # 473a <printf>
      exit(1);
    3548:	4505                	li	a0,1
    354a:	00001097          	auipc	ra,0x1
    354e:	e58080e7          	jalr	-424(ra) # 43a2 <exit>
...
0000000000003552 <sbrkbasic>:
{
  ...
  a = sbrk(TOOMUCH);
    ...
    356c:	ec2080e7          	jalr	-318(ra) # 442a <sbrk>
  if(a != (char*)0xffffffffffffffffL){
    ...
    357c:	cc850513          	addi	a0,a0,-824 # 6240 <malloc+0x1a48>
    3580:	00001097          	auipc	ra,0x1
    3584:	1ba080e7          	jalr	442(ra) # 473a <printf>
    exit(1);
    3588:	4505                	li	a0,1
    358a:	00001097          	auipc	ra,0x1
    358e:	e18080e7          	jalr	-488(ra) # 43a2 <exit>
  a = sbrk(0);
    3592:	4501                	li	a0,0
    3594:	00001097          	auipc	ra,0x1
    3598:	e96080e7          	jalr	-362(ra) # 442a <sbrk>
    359c:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    359e:	4901                	li	s2,0
    ...
    35b0:	e7e080e7          	jalr	-386(ra) # 442a <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    35cc:	dd2080e7          	jalr	-558(ra) # 439a <fork>
    35d0:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    35dc:	e52080e7          	jalr	-430(ra) # 442a <sbrk>
  c = sbrk(1);
    35e0:	4505                	li	a0,1
    35e2:	00001097          	auipc	ra,0x1
    35e6:	e48080e7          	jalr	-440(ra) # 442a <sbrk>
  if(c != a + 1){
    ...
    35f6:	cb650513          	addi	a0,a0,-842 # 62a8 <malloc+0x1ab0>
    35fa:	00001097          	auipc	ra,0x1
    35fe:	140080e7          	jalr	320(ra) # 473a <printf>
    exit(1);
    3602:	4505                	li	a0,1
    3604:	00001097          	auipc	ra,0x1
    3608:	d9e080e7          	jalr	-610(ra) # 43a2 <exit>
      printf("%s: sbrk test failed %d %x %x\n", i, a, b);
    360c:	86aa                	mv	a3,a0
    360e:	8626                	mv	a2,s1
    3610:	85ca                	mv	a1,s2
    3612:	00003517          	auipc	a0,0x3
    3616:	c5650513          	addi	a0,a0,-938 # 6268 <malloc+0x1a70>
    361a:	00001097          	auipc	ra,0x1
    361e:	120080e7          	jalr	288(ra) # 473a <printf>
      exit(1);
    3622:	4505                	li	a0,1
    3624:	00001097          	auipc	ra,0x1
    3628:	d7e080e7          	jalr	-642(ra) # 43a2 <exit>
    printf("%s: sbrk test fork failed\n", s);
    362c:	85d2                	mv	a1,s4
    362e:	00003517          	auipc	a0,0x3
    3632:	c5a50513          	addi	a0,a0,-934 # 6288 <malloc+0x1a90>
    3636:	00001097          	auipc	ra,0x1
    363a:	104080e7          	jalr	260(ra) # 473a <printf>
    exit(1);
    363e:	4505                	li	a0,1
    3640:	00001097          	auipc	ra,0x1
    3644:	d62080e7          	jalr	-670(ra) # 43a2 <exit>
  if(pid == 0)
  ...
  wait(&xstatus);
    ...
    365e:	d50080e7          	jalr	-688(ra) # 43aa <wait>
  exit(xstatus);
    3662:	fcc42503          	lw	a0,-52(s0)
    3666:	00001097          	auipc	ra,0x1
    366a:	d3c080e7          	jalr	-708(ra) # 43a2 <exit>
...
000000000000366e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  c = sbrk(0);
    ...
    36d8:	d56080e7          	jalr	-682(ra) # 442a <sbrk>
  if(c != a - PGSIZE){
  ...
  if(c != a){
    ...
    375e:	b6e50513          	addi	a0,a0,-1170 # 62c8 <malloc+0x1ad0>
    3762:	00001097          	auipc	ra,0x1
    3766:	fd8080e7          	jalr	-40(ra) # 473a <printf>
    exit(1);
    376a:	4505                	li	a0,1
    376c:	00001097          	auipc	ra,0x1
    3770:	c36080e7          	jalr	-970(ra) # 43a2 <exit>
    printf("%s: sbrk could not deallocate\n", s);
    3774:	85ce                	mv	a1,s3
    3776:	00003517          	auipc	a0,0x3
    377a:	b9a50513          	addi	a0,a0,-1126 # 6310 <malloc+0x1b18>
    377e:	00001097          	auipc	ra,0x1
    3782:	fbc080e7          	jalr	-68(ra) # 473a <printf>
    exit(1);
    3786:	4505                	li	a0,1
    3788:	00001097          	auipc	ra,0x1
    378c:	c1a080e7          	jalr	-998(ra) # 43a2 <exit>
    printf("%s: sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3790:	862a                	mv	a2,a0
    3792:	85a6                	mv	a1,s1
    3794:	00003517          	auipc	a0,0x3
    3798:	b9c50513          	addi	a0,a0,-1124 # 6330 <malloc+0x1b38>
    379c:	00001097          	auipc	ra,0x1
    37a0:	f9e080e7          	jalr	-98(ra) # 473a <printf>
    exit(1);
    37a4:	4505                	li	a0,1
    37a6:	00001097          	auipc	ra,0x1
    37aa:	bfc080e7          	jalr	-1028(ra) # 43a2 <exit>
    printf("%s: sbrk re-allocation failed, a %x c %x\n", a, c);
    37ae:	8652                	mv	a2,s4
    37b0:	85a6                	mv	a1,s1
    37b2:	00003517          	auipc	a0,0x3
    37b6:	bbe50513          	addi	a0,a0,-1090 # 6370 <malloc+0x1b78>
    37ba:	00001097          	auipc	ra,0x1
    37be:	f80080e7          	jalr	-128(ra) # 473a <printf>
    exit(1);
    37c2:	4505                	li	a0,1
    37c4:	00001097          	auipc	ra,0x1
    37c8:	bde080e7          	jalr	-1058(ra) # 43a2 <exit>
    printf("%s: sbrk de-allocation didn't really deallocate\n", s);
    37cc:	85ce                	mv	a1,s3
    37ce:	00003517          	auipc	a0,0x3
    37d2:	bd250513          	addi	a0,a0,-1070 # 63a0 <malloc+0x1ba8>
    37d6:	00001097          	auipc	ra,0x1
    37da:	f64080e7          	jalr	-156(ra) # 473a <printf>
    exit(1);
    37de:	4505                	li	a0,1
    37e0:	00001097          	auipc	ra,0x1
    37e4:	bc2080e7          	jalr	-1086(ra) # 43a2 <exit>
    printf("%s: sbrk downsize failed, a %x c %x\n", a, c);
    37e8:	862a                	mv	a2,a0
    37ea:	85a6                	mv	a1,s1
    37ec:	00003517          	auipc	a0,0x3
    37f0:	bec50513          	addi	a0,a0,-1044 # 63d8 <malloc+0x1be0>
    37f4:	00001097          	auipc	ra,0x1
    37f8:	f46080e7          	jalr	-186(ra) # 473a <printf>
    exit(1);
    37fc:	4505                	li	a0,1
    37fe:	00001097          	auipc	ra,0x1
    3802:	ba4080e7          	jalr	-1116(ra) # 43a2 <exit>
...
0000000000003806 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3822:	b94080e7          	jalr	-1132(ra) # 43b2 <pipe>
    ...
    383c:	df050513          	addi	a0,a0,-528 # 5628 <malloc+0xe30>
    3840:	00001097          	auipc	ra,0x1
    3844:	efa080e7          	jalr	-262(ra) # 473a <printf>
    exit(1);
    3848:	4505                	li	a0,1
    384a:	00001097          	auipc	ra,0x1
    384e:	b58080e7          	jalr	-1192(ra) # 43a2 <exit>
      sbrk(BIG - (uint64)sbrk(0));
    3852:	00001097          	auipc	ra,0x1
    3856:	bd8080e7          	jalr	-1064(ra) # 442a <sbrk>
    385a:	064007b7          	lui	a5,0x6400
    385e:	40a7853b          	subw	a0,a5,a0
    3862:	00001097          	auipc	ra,0x1
    3866:	bc8080e7          	jalr	-1080(ra) # 442a <sbrk>
      write(fds[1], "x", 1);
    386a:	4605                	li	a2,1
    386c:	00002597          	auipc	a1,0x2
    3870:	e3c58593          	addi	a1,a1,-452 # 56a8 <malloc+0xeb0>
    3874:	fb442503          	lw	a0,-76(s0)
    3878:	00001097          	auipc	ra,0x1
    387c:	b4a080e7          	jalr	-1206(ra) # 43c2 <write>
      for(;;) sleep(1000);
    3880:	3e800513          	li	a0,1000
    3884:	00001097          	auipc	ra,0x1
    3888:	bae080e7          	jalr	-1106(ra) # 4432 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3898:	b06080e7          	jalr	-1274(ra) # 439a <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    38da:	afc080e7          	jalr	-1284(ra) # 43d2 <kill>
    wait(0);
    38de:	4501                	li	a0,0
    38e0:	00001097          	auipc	ra,0x1
    38e4:	aca080e7          	jalr	-1334(ra) # 43aa <wait>
  ...
  pid = fork();
    ...
    38f4:	aaa080e7          	jalr	-1366(ra) # 439a <fork>
    38f8:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    3908:	aa6080e7          	jalr	-1370(ra) # 43aa <wait>
  if(xstatus != -1)
    ...
    392e:	ad650513          	addi	a0,a0,-1322 # 6400 <malloc+0x1c08>
    3932:	00001097          	auipc	ra,0x1
    3936:	e08080e7          	jalr	-504(ra) # 473a <printf>
    exit(1);
    393a:	4505                	li	a0,1
    393c:	00001097          	auipc	ra,0x1
    3940:	a66080e7          	jalr	-1434(ra) # 43a2 <exit>
    printf("%s: fork failed\n", s);
    3944:	85d6                	mv	a1,s5
    3946:	00001517          	auipc	a0,0x1
    394a:	3b250513          	addi	a0,a0,946 # 4cf8 <malloc+0x500>
    394e:	00001097          	auipc	ra,0x1
    3952:	dec080e7          	jalr	-532(ra) # 473a <printf>
    exit(1);
    3956:	4505                	li	a0,1
    3958:	00001097          	auipc	ra,0x1
    395c:	a4a080e7          	jalr	-1462(ra) # 43a2 <exit>
    a = sbrk(0);
    3960:	4501                	li	a0,0
    3962:	00001097          	auipc	ra,0x1
    3966:	ac8080e7          	jalr	-1336(ra) # 442a <sbrk>
    396a:	892a                	mv	s2,a0
    sbrk(10*BIG);
    ...
    3980:	6705                	lui	a4,0x1
      n += *(a+i);
    3982:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f3e38>
    ...
    3994:	a9050513          	addi	a0,a0,-1392 # 6420 <malloc+0x1c28>
    3998:	00001097          	auipc	ra,0x1
    399c:	da2080e7          	jalr	-606(ra) # 473a <printf>
    exit(1);
    39a0:	4505                	li	a0,1
    39a2:	00001097          	auipc	ra,0x1
    39a6:	a00080e7          	jalr	-1536(ra) # 43a2 <exit>
    exit(1);
    39aa:	4505                	li	a0,1
    39ac:	00001097          	auipc	ra,0x1
    39b0:	9f6080e7          	jalr	-1546(ra) # 43a2 <exit>
...
00000000000039b4 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    39d8:	a7c50513          	addi	a0,a0,-1412 # 6450 <malloc+0x1c58>
    39dc:	00001097          	auipc	ra,0x1
    39e0:	a06080e7          	jalr	-1530(ra) # 43e2 <open>
    39e4:	84aa                	mv	s1,a0
  unlink("sbrk");
    39e6:	00003517          	auipc	a0,0x3
    39ea:	a6a50513          	addi	a0,a0,-1430 # 6450 <malloc+0x1c58>
    39ee:	00001097          	auipc	ra,0x1
    39f2:	a04080e7          	jalr	-1532(ra) # 43f2 <unlink>
  if(fd < 0)  {
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    3a04:	9c2080e7          	jalr	-1598(ra) # 43c2 <write>
    3a08:	04054663          	bltz	a0,3a54 <sbrkarg+0xa0>
  close(fd);
    3a0c:	8526                	mv	a0,s1
    3a0e:	00001097          	auipc	ra,0x1
    3a12:	9bc080e7          	jalr	-1604(ra) # 43ca <close>
  a = sbrk(PGSIZE);
    3a16:	6505                	lui	a0,0x1
    3a18:	00001097          	auipc	ra,0x1
    3a1c:	a12080e7          	jalr	-1518(ra) # 442a <sbrk>
  if(pipe((int *) a) != 0){
    3a20:	00001097          	auipc	ra,0x1
    3a24:	992080e7          	jalr	-1646(ra) # 43b2 <pipe>
    ...
    3a3e:	a1e50513          	addi	a0,a0,-1506 # 6458 <malloc+0x1c60>
    3a42:	00001097          	auipc	ra,0x1
    3a46:	cf8080e7          	jalr	-776(ra) # 473a <printf>
    exit(1);
    3a4a:	4505                	li	a0,1
    3a4c:	00001097          	auipc	ra,0x1
    3a50:	956080e7          	jalr	-1706(ra) # 43a2 <exit>
    printf("%s: write sbrk failed\n", s);
    3a54:	85ce                	mv	a1,s3
    3a56:	00003517          	auipc	a0,0x3
    3a5a:	a1a50513          	addi	a0,a0,-1510 # 6470 <malloc+0x1c78>
    3a5e:	00001097          	auipc	ra,0x1
    3a62:	cdc080e7          	jalr	-804(ra) # 473a <printf>
    exit(1);
    3a66:	4505                	li	a0,1
    3a68:	00001097          	auipc	ra,0x1
    3a6c:	93a080e7          	jalr	-1734(ra) # 43a2 <exit>
    printf("%s: pipe() failed\n", s);
    3a70:	85ce                	mv	a1,s3
    3a72:	00002517          	auipc	a0,0x2
    3a76:	bb650513          	addi	a0,a0,-1098 # 5628 <malloc+0xe30>
    3a7a:	00001097          	auipc	ra,0x1
    3a7e:	cc0080e7          	jalr	-832(ra) # 473a <printf>
    exit(1);
    3a82:	4505                	li	a0,1
    3a84:	00001097          	auipc	ra,0x1
    3a88:	91e080e7          	jalr	-1762(ra) # 43a2 <exit>
...
0000000000003a8c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3aa0:	9ec50513          	addi	a0,a0,-1556 # 6488 <malloc+0x1c90>
    3aa4:	00001097          	auipc	ra,0x1
    3aa8:	93e080e7          	jalr	-1730(ra) # 43e2 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3ab8:	976080e7          	jalr	-1674(ra) # 442a <sbrk>
    3abc:	567d                	li	a2,-1
    3abe:	fff50593          	addi	a1,a0,-1
    3ac2:	8526                	mv	a0,s1
    3ac4:	00001097          	auipc	ra,0x1
    3ac8:	8f6080e7          	jalr	-1802(ra) # 43ba <read>
  close(fd);
    3acc:	8526                	mv	a0,s1
    3ace:	00001097          	auipc	ra,0x1
    3ad2:	8fc080e7          	jalr	-1796(ra) # 43ca <close>
}
    ...
    3ae8:	9e450513          	addi	a0,a0,-1564 # 54c8 <malloc+0xcd0>
    3aec:	00001097          	auipc	ra,0x1
    3af0:	c4e080e7          	jalr	-946(ra) # 473a <printf>
    exit(1);
    3af4:	4505                	li	a0,1
    3af6:	00001097          	auipc	ra,0x1
    3afa:	8ac080e7          	jalr	-1876(ra) # 43a2 <exit>
...
0000000000003afe <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    3b0a:	894080e7          	jalr	-1900(ra) # 439a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3b18:	916080e7          	jalr	-1770(ra) # 442a <sbrk>
    sbrk(-sz);
    3b1c:	40a0053b          	negw	a0,a0
    3b20:	00001097          	auipc	ra,0x1
    3b24:	90a080e7          	jalr	-1782(ra) # 442a <sbrk>
    exit(0);
    3b28:	4501                	li	a0,0
    3b2a:	00001097          	auipc	ra,0x1
    3b2e:	878080e7          	jalr	-1928(ra) # 43a2 <exit>
    printf("fork failed\n");
    3b32:	00002517          	auipc	a0,0x2
    3b36:	ac650513          	addi	a0,a0,-1338 # 55f8 <malloc+0xe00>
    3b3a:	00001097          	auipc	ra,0x1
    3b3e:	c00080e7          	jalr	-1024(ra) # 473a <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    3b44:	00001097          	auipc	ra,0x1
    3b48:	85e080e7          	jalr	-1954(ra) # 43a2 <exit>
  wait(0);
    3b4c:	4501                	li	a0,0
    3b4e:	00001097          	auipc	ra,0x1
    3b52:	85c080e7          	jalr	-1956(ra) # 43aa <wait>
  pid = fork();
    3b56:	00001097          	auipc	ra,0x1
    3b5a:	844080e7          	jalr	-1980(ra) # 439a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3b68:	8c6080e7          	jalr	-1850(ra) # 442a <sbrk>
    sbrk(-(sz - 3500));
    3b6c:	6785                	lui	a5,0x1
    3b6e:	dac7879b          	addiw	a5,a5,-596
    3b72:	40a7853b          	subw	a0,a5,a0
    3b76:	00001097          	auipc	ra,0x1
    3b7a:	8b4080e7          	jalr	-1868(ra) # 442a <sbrk>
    exit(0);
    3b7e:	4501                	li	a0,0
    3b80:	00001097          	auipc	ra,0x1
    3b84:	822080e7          	jalr	-2014(ra) # 43a2 <exit>
    printf("fork failed\n");
    3b88:	00002517          	auipc	a0,0x2
    3b8c:	a7050513          	addi	a0,a0,-1424 # 55f8 <malloc+0xe00>
    3b90:	00001097          	auipc	ra,0x1
    3b94:	baa080e7          	jalr	-1110(ra) # 473a <printf>
    exit(1);
    3b98:	4505                	li	a0,1
    3b9a:	00001097          	auipc	ra,0x1
    3b9e:	808080e7          	jalr	-2040(ra) # 43a2 <exit>
  wait(0);
    3ba2:	4501                	li	a0,0
    3ba4:	00001097          	auipc	ra,0x1
    3ba8:	806080e7          	jalr	-2042(ra) # 43aa <wait>
  pid = fork();
    3bac:	00000097          	auipc	ra,0x0
    3bb0:	7ee080e7          	jalr	2030(ra) # 439a <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3bbe:	870080e7          	jalr	-1936(ra) # 442a <sbrk>
    3bc2:	67ad                	lui	a5,0xb
    3bc4:	8007879b          	addiw	a5,a5,-2048
    3bc8:	40a7853b          	subw	a0,a5,a0
    3bcc:	00001097          	auipc	ra,0x1
    3bd0:	85e080e7          	jalr	-1954(ra) # 442a <sbrk>
    sbrk(-10);
    3bd4:	5559                	li	a0,-10
    3bd6:	00001097          	auipc	ra,0x1
    3bda:	854080e7          	jalr	-1964(ra) # 442a <sbrk>
    exit(0);
    3bde:	4501                	li	a0,0
    3be0:	00000097          	auipc	ra,0x0
    3be4:	7c2080e7          	jalr	1986(ra) # 43a2 <exit>
    printf("fork failed\n");
    3be8:	00002517          	auipc	a0,0x2
    3bec:	a1050513          	addi	a0,a0,-1520 # 55f8 <malloc+0xe00>
    3bf0:	00001097          	auipc	ra,0x1
    3bf4:	b4a080e7          	jalr	-1206(ra) # 473a <printf>
    exit(1);
    3bf8:	4505                	li	a0,1
    3bfa:	00000097          	auipc	ra,0x0
    3bfe:	7a8080e7          	jalr	1960(ra) # 43a2 <exit>
  wait(0);
    3c02:	4501                	li	a0,0
    3c04:	00000097          	auipc	ra,0x0
    3c08:	7a6080e7          	jalr	1958(ra) # 43aa <wait>
  exit(0);
    3c0c:	4501                	li	a0,0
    3c0e:	00000097          	auipc	ra,0x0
    3c12:	794080e7          	jalr	1940(ra) # 43a2 <exit>
...
0000000000003c16 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    3c26:	86e50513          	addi	a0,a0,-1938 # 6490 <malloc+0x1c98>
    3c2a:	00001097          	auipc	ra,0x1
    3c2e:	b10080e7          	jalr	-1264(ra) # 473a <printf>
  if(mkdir("dir0") < 0){
    3c32:	00003517          	auipc	a0,0x3
    3c36:	86e50513          	addi	a0,a0,-1938 # 64a0 <malloc+0x1ca8>
    3c3a:	00000097          	auipc	ra,0x0
    3c3e:	7d0080e7          	jalr	2000(ra) # 440a <mkdir>
    3c42:	04054d63          	bltz	a0,3c9c <dirtest+0x86>
  if(chdir("dir0") < 0){
    3c46:	00003517          	auipc	a0,0x3
    3c4a:	85a50513          	addi	a0,a0,-1958 # 64a0 <malloc+0x1ca8>
    3c4e:	00000097          	auipc	ra,0x0
    3c52:	7c4080e7          	jalr	1988(ra) # 4412 <chdir>
    3c56:	06054163          	bltz	a0,3cb8 <dirtest+0xa2>
  if(chdir("..") < 0){
    3c5a:	00001517          	auipc	a0,0x1
    3c5e:	00e50513          	addi	a0,a0,14 # 4c68 <malloc+0x470>
    3c62:	00000097          	auipc	ra,0x0
    3c66:	7b0080e7          	jalr	1968(ra) # 4412 <chdir>
    3c6a:	06054563          	bltz	a0,3cd4 <dirtest+0xbe>
  if(unlink("dir0") < 0){
    3c6e:	00003517          	auipc	a0,0x3
    3c72:	83250513          	addi	a0,a0,-1998 # 64a0 <malloc+0x1ca8>
    3c76:	00000097          	auipc	ra,0x0
    3c7a:	77c080e7          	jalr	1916(ra) # 43f2 <unlink>
    3c7e:	06054963          	bltz	a0,3cf0 <dirtest+0xda>
  printf("%s: mkdir test ok\n");
    3c82:	00003517          	auipc	a0,0x3
    3c86:	86e50513          	addi	a0,a0,-1938 # 64f0 <malloc+0x1cf8>
    3c8a:	00001097          	auipc	ra,0x1
    3c8e:	ab0080e7          	jalr	-1360(ra) # 473a <printf>
}
    ...
    3ca2:	eea50513          	addi	a0,a0,-278 # 4b88 <malloc+0x390>
    3ca6:	00001097          	auipc	ra,0x1
    3caa:	a94080e7          	jalr	-1388(ra) # 473a <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    3cb0:	00000097          	auipc	ra,0x0
    3cb4:	6f2080e7          	jalr	1778(ra) # 43a2 <exit>
    printf("%s: chdir dir0 failed\n", s);
    3cb8:	85a6                	mv	a1,s1
    3cba:	00002517          	auipc	a0,0x2
    3cbe:	7ee50513          	addi	a0,a0,2030 # 64a8 <malloc+0x1cb0>
    3cc2:	00001097          	auipc	ra,0x1
    3cc6:	a78080e7          	jalr	-1416(ra) # 473a <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    3ccc:	00000097          	auipc	ra,0x0
    3cd0:	6d6080e7          	jalr	1750(ra) # 43a2 <exit>
    printf("%s: chdir .. failed\n", s);
    3cd4:	85a6                	mv	a1,s1
    3cd6:	00002517          	auipc	a0,0x2
    3cda:	7ea50513          	addi	a0,a0,2026 # 64c0 <malloc+0x1cc8>
    3cde:	00001097          	auipc	ra,0x1
    3ce2:	a5c080e7          	jalr	-1444(ra) # 473a <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    3ce8:	00000097          	auipc	ra,0x0
    3cec:	6ba080e7          	jalr	1722(ra) # 43a2 <exit>
    printf("%s: unlink dir0 failed\n", s);
    3cf0:	85a6                	mv	a1,s1
    3cf2:	00002517          	auipc	a0,0x2
    3cf6:	7e650513          	addi	a0,a0,2022 # 64d8 <malloc+0x1ce0>
    3cfa:	00001097          	auipc	ra,0x1
    3cfe:	a40080e7          	jalr	-1472(ra) # 473a <printf>
    exit(1);
    3d02:	4505                	li	a0,1
...
0000000000003d0c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    3d2e:	7de50513          	addi	a0,a0,2014 # 6508 <malloc+0x1d10>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3d4e:	7cec8c93          	addi	s9,s9,1998 # 6518 <malloc+0x1d20>
    int total = 0;
    3d52:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    3d54:	00005a17          	auipc	s4,0x5
    3d58:	464a0a13          	addi	s4,s4,1124 # 91b8 <buf>
    name[0] = 'f';
    ...
    3dc8:	76450513          	addi	a0,a0,1892 # 6528 <malloc+0x1d30>
  ...
  printf("fsfull test finished\n");
    ...
    3e3e:	71e50513          	addi	a0,a0,1822 # 6558 <malloc+0x1d60>
    ...
    3e8e:	6b650513          	addi	a0,a0,1718 # 6540 <malloc+0x1d48>
...
0000000000003eac <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3eb6:	ade70713          	addi	a4,a4,-1314 # 6990 <randstate>
    3eba:	6308                	ld	a0,0(a4)
    3ebc:	001967b7          	lui	a5,0x196
    3ec0:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x18a445>
    3ec4:	02f50533          	mul	a0,a0,a5
    3ec8:	3c6ef7b7          	lui	a5,0x3c6ef
    3ecc:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e3197>
...
0000000000003edc <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    3f50:	62450513          	addi	a0,a0,1572 # 6570 <malloc+0x1d78>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    3f68:	74458593          	addi	a1,a1,1860 # 56a8 <malloc+0xeb0>
    ...
    3f7e:	61650513          	addi	a0,a0,1558 # 6590 <malloc+0x1d98>
    ...
    3f98:	5e450513          	addi	a0,a0,1508 # 6578 <malloc+0x1d80>
    ...
    3fb2:	5ca50513          	addi	a0,a0,1482 # 6578 <malloc+0x1d80>
  ...
  unlink("junk");
    ...
    3fd6:	59e50513          	addi	a0,a0,1438 # 6570 <malloc+0x1d78>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4000:	5a450513          	addi	a0,a0,1444 # 65a0 <malloc+0x1da8>
  ...
  if(pid == 0) {
    ...
    4032:	59a50513          	addi	a0,a0,1434 # 65c8 <malloc+0x1dd0>
    ...
    4056:	55e50513          	addi	a0,a0,1374 # 65b0 <malloc+0x1db8>
    ...
    4080:	55450513          	addi	a0,a0,1364 # 65d0 <malloc+0x1dd8>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    40bc:	5c078793          	addi	a5,a5,1472 # 6678 <malloc+0x1e80>
    40c0:	ce040713          	addi	a4,s0,-800
    40c4:	00003817          	auipc	a6,0x3
    40c8:	89480813          	addi	a6,a6,-1900 # 6958 <malloc+0x2160>
  ...
  printf("usertests starting\n");
    ...
    40f4:	4e850513          	addi	a0,a0,1256 # 65d8 <malloc+0x1de0>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    4106:	4ee50513          	addi	a0,a0,1262 # 65f0 <malloc+0x1df8>
    ...
    411a:	4ea50513          	addi	a0,a0,1258 # 6600 <malloc+0x1e08>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    4138:	4bc50513          	addi	a0,a0,1212 # 65f0 <malloc+0x1df8>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    44aa:	4ca50513          	addi	a0,a0,1226 # 6970 <digits>
    44ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    4576:	3feb8b93          	addi	s7,s7,1022 # 6970 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    46b6:	2b690913          	addi	s2,s2,694 # 6968 <malloc+0x2170>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    477e:	2267b783          	ld	a5,550(a5) # 69a0 <freep>
    ...
    47ac:	00e6ea63          	bltu	a3,a4,47c0 <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    47c6:	02059713          	slli	a4,a1,0x20
    47ca:	9301                	srli	a4,a4,0x20
    47cc:	0712                	slli	a4,a4,0x4
  ...
  if(p + p->s.size == bp){
    ...
    47da:	02061713          	slli	a4,a2,0x20
    47de:	9301                	srli	a4,a4,0x20
    47e0:	0712                	slli	a4,a4,0x4
  ...
  freep = p;
    ...
    47ee:	1af73b23          	sd	a5,438(a4) # 69a0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4820:	18453503          	ld	a0,388(a0) # 69a0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4848:	15c90913          	addi	s2,s2,348 # 69a0 <freep>
  if(p == (char*)-1)
    484c:	5afd                	li	s5,-1
    484e:	a88d                	j	48c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    4850:	00008797          	auipc	a5,0x8
    4854:	96878793          	addi	a5,a5,-1688 # c1b8 <base>
    4858:	00002717          	auipc	a4,0x2
    485c:	14f73423          	sd	a5,328(a4) # 69a0 <freep>
    ...
    4866:	b7e1                	j	482e <malloc+0x36>
      if(p->s.size == nunits)
    4868:	02e48b63          	beq	s1,a4,489e <malloc+0xa6>
        p->s.size -= nunits;
    486c:	4137073b          	subw	a4,a4,s3
    4870:	c798                	sw	a4,8(a5)
        p += p->s.size;
    4872:	1702                	slli	a4,a4,0x20
    4874:	9301                	srli	a4,a4,0x20
    4876:	0712                	slli	a4,a4,0x4
    4878:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    487a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    487e:	00002717          	auipc	a4,0x2
    4882:	12a73123          	sd	a0,290(a4) # 69a0 <freep>
      return (void*)(p + 1);
    4886:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    488a:	70e2                	ld	ra,56(sp)
    488c:	7442                	ld	s0,48(sp)
    488e:	74a2                	ld	s1,40(sp)
    4890:	7902                	ld	s2,32(sp)
    4892:	69e2                	ld	s3,24(sp)
    4894:	6a42                	ld	s4,16(sp)
    4896:	6aa2                	ld	s5,8(sp)
    4898:	6b02                	ld	s6,0(sp)
    489a:	6121                	addi	sp,sp,64
    489c:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    489e:	6398                	ld	a4,0(a5)
    48a0:	e118                	sd	a4,0(a0)
    48a2:	bff1                	j	487e <malloc+0x86>
  hp->s.size = nu;
    48a4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    48a8:	0541                	addi	a0,a0,16
    48aa:	00000097          	auipc	ra,0x0
    48ae:	ec6080e7          	jalr	-314(ra) # 4770 <free>
  return freep;
    48b2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    48b6:	d971                	beqz	a0,488a <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    48b8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    48ba:	4798                	lw	a4,8(a5)
    48bc:	fa9776e3          	bgeu	a4,s1,4868 <malloc+0x70>
    if(p == freep)
    48c0:	00093703          	ld	a4,0(s2)
    48c4:	853e                	mv	a0,a5
    48c6:	fef719e3          	bne	a4,a5,48b8 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    48ca:	8552                	mv	a0,s4
    48cc:	00000097          	auipc	ra,0x0
    48d0:	b5e080e7          	jalr	-1186(ra) # 442a <sbrk>
  if(p == (char*)-1)
    48d4:	fd5518e3          	bne	a0,s5,48a4 <malloc+0xac>
        return 0;
    48d8:	4501                	li	a0,0
    48da:	bf45                	j	488a <malloc+0x92>
